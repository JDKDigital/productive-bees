...
public class SmallBeeModel extends PartialBeeModel
{
    ...
    protected void addTorso(boolean withTorso) {
        ...
        stinger.setTextureOffset(22, 6).addBox(0.0F, -0.5F, 4.0F, 0.0F, 1.0F, 1.0F, 0.0F, 0.0F, 0.0F);
    ...
    protected void addWings() {
        rightWing.setRotationPoint(-0.5F, -3.0F, -2.0F);
        ...
        leftWing.setRotationPoint(0.5F, -3.0F, -2.0F);
    ...
    protected void addLegs() {
        ...
        frontLegs.setTextureOffset(22, 1).addBox(-4.5F, 0.0F, 0.0F, 6.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F);
        middleLegs.setRotationPoint(1.5F, 3.0F, 0.0F);
        middleLegs.setTextureOffset(22, 3).addBox(-4.5F, 0.0F, 0.0F, 6.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F);
        backLegs.setRotationPoint(1.5F, 3.0F, 2.0F);
        backLegs.setTextureOffset(22, 5).addBox(-4.5F, 0.0F, 0.0F, 6.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F);
