...
public class BeeProvider implements DataProvider
{
    ...
    protected List<BeeConfig> getBeeConfigs() {
        return new ArrayList<>() {{
            ...
            add(new BeeConfig("wanna").primaryColor("#3b2754").secondaryColor("#06030b").particleColor("#3b2754").beeTexture("wanna").renderer("thicc").noComb().attributes(new HashMap<>(){{ put("endurance", GeneValue.ENDURANCE_STRONG.getSerializedName()); }}).flowerBlock("productivebees:amber").noSelfBreed());
            ...
            add(new BeeConfig("ae2/entro").primaryColor("#035256").secondaryColor("#03b99a").tertiaryColor("#65e883").particleColor("#f4ffb5").renderer("default_crystal").size(0.8).beeTexture("entro").flowerBlock("extendedae:entro_block").requireMod("extendedae").noSelfBreed());
            add(new BeeConfig("ae2/redstone_crystal").primaryColor("#5c0404").secondaryColor("#b51d1d").tertiaryColor("#e34848").particleColor("#ffa58c").renderer("default_crystal").size(0.7).beeTexture("redstone_crystal").flowerBlock("appflux:charged_redstone_block").requireMod("appflux").noSelfBreed());
            add(new BeeConfig("ae2/sky_bronze").primaryColor("#2e0b05").secondaryColor("#5c2513").tertiaryColor("#804a2b").particleColor("#bfb57c").renderer("default_crystal").size(0.8).beeTexture("sky_bronze").flowerBlock("megacells:sky_bronze_block").requireMod("megacells").noSelfBreed());
            add(new BeeConfig("ae2/sky_osmium").primaryColor("#222030").secondaryColor("#353149").tertiaryColor("#635089").particleColor("#d4a3c0").size(0.6).beeTexture("sky_osmium").flowerBlock("megacells:sky_osmium_block").requireMod("megacells").noSelfBreed());
            ...
            add(new BeeConfig("raw_materials/mithril").primaryColor("#0b2638").secondaryColor("#0e6a61").particleColor("#92e7ae").flowerTag("c:storage_blocks/mithril").beeTexture("mithril").requireTag("c:storage_blocks/mithril"));
