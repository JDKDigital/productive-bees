...
public class BeeProvider implements DataProvider
{
    ...
    protected List<BeeConfig> getBeeConfigs() {
        return new ArrayList<>() {{
            ...
            add(new BeeConfig("thermal_extra/suol_infused").primaryColor("#b7785a").secondaryColor("#db9e70").tertiaryColor("#ffd68e").particleColor("#ffd68e").onlySpawnegg().size(0.7).flowerBlock("thermal_extra:soul_infused_block").requireMod("thermal_extra"));
