...
public class BeeProvider implements DataProvider
{
    ...
    protected List<BeeConfig> getBeeConfigs() {
        return new ArrayList<>() {{
            ...
            add(new BeeConfig("draconic").primaryColor("#1c1c1c").secondaryColor("#5f2525").particleColor("#cc00fa").beeTexture("draconic").attributes(new HashMap<>(){{  put("endurance", 3);  put("temper", 2); }}).breedingItem("productivebees:draconic_dust").breedingItemCount(2).draconic().flowerTag("productivebees:flowers/draconic_flowers").nestingPreference("productivebees:nests/draconic_nests"));
            add(new BeeConfig("ender").primaryColor("#161616").secondaryColor("#6238757").particleColor("#cc00fa").particleType("portal").size(0.8).beeTexture("ender").attributes(new HashMap<>(){{ put("endurance", 1); }}).teleporting().flowerTag("productivebees:flowers/ender").nestingPreference("productivebees:nests/end_nests"));
            add(new BeeConfig("experience").primaryColor("#00fc1a").secondaryColor("#884739").particleColor("#00fc1a").flowerTag("forge:bookshelves"));
            ...
            add(new BeeConfig("ghostly").primaryColor("#eeeeee").beeTexture("ghostly").translucent().noComb().attributes(new HashMap<>(){{ put("behavior", 1); }}).flowerTag("productivebees:flowers/souled_flowers").nestingPreference("productivebees:nests/soul_sand_nests"));
            add(new BeeConfig("kamikaz").primaryColor("#FFFF00").secondaryColor("#000001").particleType("pop").attributes(new HashMap<>(){{  put("productivity", 3);  put("endurance", 0);  put("temper", 3); }}).noComb().noSelfBreed().speed(5).attack(6.0).size(0.2));
            add(new BeeConfig("magmatic").primaryColor("#d06a1b").secondaryColor("#100000").particleColor("#d06a1b").beeTexture("magmatic").renderer("translucent_with_center").flowerTag("productivebees:flowers/magmatic_flowers").nestingPreference("productivebees:nests/nether_brick_nests").attackResponse("lava").particleType("lava").fireproof().passiveEffects(new ArrayList<>() {{ add(new PassiveEffect("minecraft:fire_resistance", 400)); }}));
            add(new BeeConfig("obsidian").primaryColor("#3b2754").secondaryColor("#06030b").particleColor("#3b2754").renderer("thicc").size(0.85).attributes(new HashMap<>(){{  put("endurance", 3); }}).flowerTag("forge:obsidian"));
            ...
            add(new BeeConfig("prismarine").primaryColor("#79b7ab").secondaryColor("#315041").tertiaryColor("#5e85a4").particleColor("#267a4b").renderer("default_crystal").size(0.6).attributes(new HashMap<>(){{  put("endurance", 3);  put("productivity", 0);  put("temper", 3);  put("weather_tolerance", 2); }}).waterproof().flowerTag("productivebees:flowers/prismarine"));
            add(new BeeConfig("sculk").primaryColor("#141414").particleColor("#141414").beeTexture("sculk").noSelfBreed().flowerBlock("minecraft:sculk_shrieker").attributes(new HashMap<>(){{  put("temper", 2);  put("behavior", 1); }}).passiveEffects(new ArrayList<>() {{ add(new PassiveEffect("minecraft:darkness", 60)); }}));
            ...
            add(new BeeConfig("skeletal").primaryColor("#c1c1c1").beeTexture("skeletal").noSelfBreed().flowerBlock("minecraft:bone_block").attributes(new HashMap<>(){{ put("behavior", 1); }}));
            add(new BeeConfig("slimy").primaryColor("#2ff757").secondaryColor("#6238757").particleColor("#2ff757").beeTexture("slimy").renderer("translucent_with_center").attributes(new HashMap<>(){{ put("temper", 0); }}).slimy().flowerTag("productivebees:flowers/swamp_flowers").nestingPreference("productivebees:nests/slimy_nests"));
            add(new BeeConfig("sponge").primaryColor("#cccc4c").secondaryColor("#9c8c3c").particleColor("#3c4c9c").size(0.7).pollinatedSize(1.1).beeTexture("sponge").noComb().waterproof().attributes(new HashMap<>(){{ put("endurance", 1); }}).flowerBlock("minecraft:sponge"));
            add(new BeeConfig("sugarbag").primaryColor("#000000").secondaryColor("#6238757").particleColor("#99bf02").beeTexture("sugarbag").flowerBlock("minecraft:sugar_cane").noComb().renderer("tiny").attributes(new HashMap<>(){{  put("temper", 0); }}).stingless().nestingPreference("productivebees:nests/sugarbag_nests"));
            add(new BeeConfig("sussy").primaryColor("#610bff").secondaryColor("#b70000").particleColor("#4200ba").size(0.3).beeTexture("sussy").flowerBlock("minecraft:air").noComb().postPollination("sus"));
            add(new BeeConfig("wanna").primaryColor("#3b2754").secondaryColor("#06030b").particleColor("#3b2754").beeTexture("wanna").renderer("thicc").noComb().attributes(new HashMap<>(){{  put("endurance", 3); }}).flowerBlock("productivebees:amber"));
            add(new BeeConfig("withered").primaryColor("#141414").particleColor("#141414").beeTexture("wither").noSelfBreed().flowerTag("productivebees:flowers/wither_flowers").attributes(new HashMap<>(){{  put("temper", 2); put("behavior", 1); }}).withered().passiveEffects(new ArrayList<>() {{ add(new PassiveEffect("minecraft:wither", 150)); }}));
            add(new BeeConfig("zombie").primaryColor("#796565").beeTexture("zombie").munchies().noSelfBreed().attributes(new HashMap<>(){{  put("temper", 2);  put("behavior", 1); }}).passiveEffects(new ArrayList<>() {{  add(new PassiveEffect("minecraft:hunger", 150)); }}).speed(0.8));

            add(new BeeConfig("ad_astra/calorite").primaryColor("#c44249").secondaryColor("#470d2f").particleColor("#df6d5c").flowerTag("forge:storage_blocks/calorite").requireTag("forge:storage_blocks/calorite"));
            ...
            add(new BeeConfig("ad_astra/desh").primaryColor("#e9ba5d").secondaryColor("#9e4539").particleColor("#e9ba5d").flowerTag("forge:storage_blocks/desh").requireTag("forge:storage_blocks/desh"));
            add(new BeeConfig("ad_astra/ostrum").primaryColor("#966062").secondaryColor("#2c1f2d").particleColor("#564151").flowerTag("forge:storage_blocks/ostrum").requireTag("forge:storage_blocks/ostrum"));
            ...
            add(new BeeConfig("ae2/silicon").primaryColor("#918d96").secondaryColor("#6b5873").size(0.7).flowerTag("productivebees:flowers/crystalline").requireTag("forge:silicon"));
            add(new BeeConfig("ae2/sky_steel").primaryColor("#424546").secondaryColor("#87dfff").tertiaryColor("#3b5146").particleColor("#99ffcd").beeTexture("sky_steel").size(0.5).flowerBlock("megacells:sky_steel_block").noSelfBreed().requireMod("megacells"));
            ...
            add(new BeeConfig("alloys/brass").primaryColor("#DAAA4C").secondaryColor("#804f40").flowerTag("forge:storage_blocks/brass").requireTag("forge:storage_blocks/brass"));
            add(new BeeConfig("alloys/bronze").primaryColor("#C98C52").secondaryColor("#804f40").flowerTag("forge:storage_blocks/bronze").requireTag("forge:storage_blocks/bronze"));
            add(new BeeConfig("alloys/constantan").primaryColor("#fc8669").secondaryColor("#884739").flowerTag("forge:storage_blocks/constantan").requireTag("forge:storage_blocks/constantan"));
            add(new BeeConfig("alloys/electrum").primaryColor("#D5BB4F").secondaryColor("#804f40").flowerTag("forge:storage_blocks/electrum").requireTag("forge:storage_blocks/electrum"));
            add(new BeeConfig("alloys/enderium").primaryColor("#58a28b").secondaryColor("#804f40").particleColor("#437f6c").flowerTag("forge:storage_blocks/enderium").requireTag("forge:storage_blocks/enderium"));
            add(new BeeConfig("alloys/invar").primaryColor("#ADB7B2").secondaryColor("#804f40").flowerTag("forge:storage_blocks/invar").requireTag("forge:storage_blocks/invar"));
            add(new BeeConfig("alloys/lumium").primaryColor("#f4ffc3").secondaryColor("#804f40").particleColor("#dde8ae").blinding().flowerTag("forge:storage_blocks/lumium").requireTag("forge:storage_blocks/lumium"));
            add(new BeeConfig("alloys/signalum").primaryColor("#e7917d").secondaryColor("#804f40").particleColor("#b56f60").flowerTag("forge:storage_blocks/signalum").requireTag("forge:storage_blocks/signalum"));
            add(new BeeConfig("alloys/steel").primaryColor("#737373").secondaryColor("#804f40").flowerTag("forge:storage_blocks/steel").requireTag("forge:storage_blocks/steel"));

            add(new BeeConfig("ars_nouveau/arcane").primaryColor("#c203fc").secondaryColor("#6c2482").tertiaryColor("#c203fc").particleColor("#c203fc").onlySpawnegg().renderer("default_crystal").size(0.8).attributes(new HashMap<>(){{  put("endurance", 2); }}).flowerBlock("ars_nouveau:source_gem_block").requireMod("ars_nouveau"));
            ...
            add(new BeeConfig("atm/allthemodium").primaryColor("#f2f24f").secondaryColor("#d0581f").flowerTag("forge:storage_blocks/allthemodium").breedingItem("allthemodium:vibranium_ingot").breedingItemCount(4).noSelfBreed().invulnerability(new ArrayList<>() {{  add("mekanism.radiation"); }}).requireMod("allthemodium"));
            ...
            add(new BeeConfig("atm/patrick").primaryColor("#ffffff").secondaryColor("#ffa500").beeTexture("patrick").flowerBlock("allthetweaks:atm_star_block").renderer("thicc").size(1.25).noSelfBreed().selfHeal().fireproof().attributes(new HashMap<>(){{  put("endurance", 3); }}).requireMod("allthemodium").requireMod("allthetweaks"));
            ...
            add(new BeeConfig("atm/starry").primaryColor("#d0581f").secondaryColor("#f2c01a").tertiaryColor("#fbfb5d").flowerBlock("allthetweaks:atm_star_block").renderer("default_shell").beeTexture("starry").size(1.5).noSelfBreed().selfHeal().fireproof().particleType("pop").attributes(new HashMap<>(){{  put("endurance", 3); }}).invulnerability(new ArrayList<>() {{ add("mekanism.radiation"); }}).requireMod("allthemodium").requireMod("allthetweaks"));
            add(new BeeConfig("atm/unobtainium").primaryColor("#bc2feb").secondaryColor("#2e237b").flowerTag("forge:storage_blocks/unobtainium").attributes(new HashMap<>(){{  put("endurance", 3); }}).noSelfBreed().invulnerability(new ArrayList<>() {{ add("mekanism.radiation"); }}).requireMod("allthemodium"));
            add(new BeeConfig("atm/vibranium").primaryColor("#73ffb9").secondaryColor("#0f5c7a").flowerTag("forge:storage_blocks/vibranium").breedingItem("allthemodium:unobtainium_ingot").breedingItemCount(4).noSelfBreed().invulnerability(new ArrayList<>() {{  add("mekanism.radiation"); }}).requireMod("allthemodium"));
            ...
            add(new BeeConfig("bloodmagic/regenerative").primaryColor("#940e00").secondaryColor("#0f0f66").particleColor("#940e00").onlySpawnegg().renderer("thicc").noSelfBreed().selfHeal().noComb().attributes(new HashMap<>(){{  put("endurance", 3);  put("temper", 2);  put("behavior", 2); }}).requireMod("bloodmagic"));

            add(new BeeConfig("botania/elementium").primaryColor("#dc5af8").secondaryColor("#804f40").onlySpawnegg().flowerTag("forge:storage_blocks/elementium").noSelfBreed().invulnerability(new ArrayList<>() {{  add("mekanism.radiation"); }}).requireMod("botania"));
            ...
            add(new BeeConfig("botania/manasteel").primaryColor("#4aa7ef").secondaryColor("#804f40").onlySpawnegg().flowerTag("forge:storage_blocks/manasteel").noSelfBreed().invulnerability(new ArrayList<>() {{  add("mekanism.radiation"); }}).requireMod("botania"));
            ...
            add(new BeeConfig("botania/terrasteel").primaryColor("#49cc1d").secondaryColor("#804f40").onlySpawnegg().flowerTag("forge:storage_blocks/terrasteel").noSelfBreed().invulnerability(new ArrayList<>() {{  add("mekanism.radiation"); }}).requireMod("botania"));
            ...
            add(new BeeConfig("chemlib/beryllium").primaryColor("#a7dbb4").particleColor("#b1e6be").beeTexture("beryllium").flowerBlock("chemlib:beryllium_metal_block").requireMod("chemlib"));
            ...
            add(new BeeConfig("chemlib/chromium").primaryColor("#d1d1d3").particleColor("#e9e9e9").beeTexture("chromium").flowerBlock("chemlib:chromium_metal_block").requireMod("chemlib"));
            ...
            add(new BeeConfig("chemlib/manganese").primaryColor("#bccddb").particleColor("#c6dadf").beeTexture("manganese").flowerBlock("chemlib:manganese_metal_block").requireMod("chemlib"));
            ...
            add(new BeeConfig("chemlib/molybdenum").primaryColor("#7e80a5").particleColor("#a7a8c3").beeTexture("molybdenum").flowerBlock("chemlib:molybdenum_metal_block").requireMod("chemlib").missingTag("forge:raw_materials/molybdenum").missingMod("gtceu"));
            ...
            add(new BeeConfig("chemlib/neodymium").primaryColor("#998784").particleColor("#ab9d9a").beeTexture("neodymium").onlySpawnegg().flowerBlock("chemlib:neodymium_metal_block").requireMod("chemlib").missingTag("forge:raw_materials/neodymium").missingMod("gtceu"));
            ...
            add(new BeeConfig("chemlib/palladium").primaryColor("#b78187").particleColor("#c3989a").beeTexture("palladium").flowerBlock("chemlib:palladium_metal_block").requireMod("chemlib").missingTag("forge:raw_materials/palladium").missingMod("gtceu"));
            ...
            add(new BeeConfig("draconicevolution/draconium").primaryColor("#1c1c1c").secondaryColor("#5f2525").particleColor("#cc00fa").tertiaryColor("#cc00fa").renderer("default_crystal").onlySpawnegg().flowerTag("forge:storage_blocks/draconium").fireproof().draconic().noSelfBreed().nestingPreference("productivebees:nests/draconic_nests").invulnerability(new ArrayList<>() {{ add("mekanism.radiation"); }}).requireMod("draconicevolution"));
            ...
            add(new BeeConfig("dusts/glowing").primaryColor("#fad87d").secondaryColor("#5f2525").particleColor("#fad87d").size(0.9).beeTexture("glowing").blinding().flowerTag("productivebees:flowers/glowing_flowers").nestingPreference("productivebees:nests/glowstone_nests").passiveEffects(new ArrayList<>() {{ add(new PassiveEffect("minecraft:glowing", 400)); }}));
            add(new BeeConfig("dusts/niter").primaryColor("#e9edf3").secondaryColor("#836e73").particleColor("#e9edf3").flowerTag("forge:storage_blocks/niter").renderer("default_crystal").requireTag("forge:storage_blocks/niter"));
            ...
            add(new BeeConfig("dusts/salty").primaryColor("#fa9f98").secondaryColor("#8a8a8a").particleColor("#fa7d73").flowerFluid("minecraft:water").waterproof().requireTag("forge:salts"));
            add(new BeeConfig("dusts/sulfur").primaryColor("#e4ff95").secondaryColor("#c9ab4b").particleColor("#f1f372").flowerTag("productivebees:flowers/sulfur").renderer("default_crystal").requireTag("forge:dusts/sulfur"));
            ...
            add(new BeeConfig("elementalcraft/drenched_iron").primaryColor("#cbddee").secondaryColor("#5590ce").particleColor("#f8f8fa").onlySpawnegg().flowerTag("forge:storage_blocks/drenched_iron").size(0.6).requireMod("elementalcraft"));
            ...
            add(new BeeConfig("elementalcraft/fireite").primaryColor("#db750e").secondaryColor("#2c0d0d").particleColor("#db750e").onlySpawnegg().flowerTag("forge:storage_blocks/fireite").size(0.6).fireproof().noSelfBreed().selfHeal().attributes(new HashMap<>(){{  put("endurance", 3); }}).invulnerability(new ArrayList<>() {{ add("mekanism.radiation"); }}).requireMod("elementalcraft"));
            ...
            add(new BeeConfig("elementalcraft/pure_crystal").primaryColor("#fffffe").secondaryColor("#beb0dd").tertiaryColor("#beb0dd").particleColor("#fffffe").renderer("default_crystal").onlySpawnegg().flowerBlock("elementalcraft:purerock").size(0.6).noSelfBreed().selfHeal().attributes(new HashMap<>(){{  put("endurance", 3); }}).invulnerability(new ArrayList<>() {{ add("mekanism.radiation"); }}).requireMod("elementalcraft"));
            ...
            add(new BeeConfig("elementalcraft/swift_alloy").primaryColor("#ebb760").secondaryColor("#c58114").particleColor("#ebb760").onlySpawnegg().flowerTag("forge:storage_blocks/swift_alloy").noSelfBreed().size(0.6).requireMod("elementalcraft"));
            ...
            add(new BeeConfig("evilcraft/bloody").primaryColor("#ba3d34").secondaryColor("#8a0303").particleColor("#ba3d34").onlySpawnegg().renderer("thicc").size(0.9).attributes(new HashMap<>(){{  put("endurance", 3);  put("productivity", 1); }}).flowerBlock("evilcraft:hardened_blood").requireMod("evilcraft"));
            add(new BeeConfig("evilcraft/dark_gem").primaryColor("#636363").secondaryColor("#2e0b17").tertiaryColor("#141414").particleColor("#636363").renderer("default_crystal").size(0.7).attributes(new HashMap<>(){{  put("temper", 2); }}).flowerBlock("evilcraft:dark_block").requireMod("evilcraft"));

            add(new BeeConfig("feywild/fey").primaryColor("#66ccff").secondaryColor("#666699").particleColor("#18abf5").onlySpawnegg().beeTexture("fey").renderer("default_crystal").particleType("pop").size(0.6).flowerTag("forge:ores/fey_gem").noSelfBreed().noComb().requireMod("feywild"));

            add(new BeeConfig("fluids/chocolate").primaryColor("#914139").secondaryColor("#804f40").particleColor("#914139").flowerBlock("minecraft:cocoa").requireFluidTag("forge:chocolate"));
            add(new BeeConfig("fluids/oily").primaryColor("#010000").secondaryColor("#804f40").particleColor("#3b2754").flowerFluid("#forge:crude_oil").waterproof().renderer("thicc").requireFluidTag("forge:crude_oil"));
            ...
            add(new BeeConfig("fluids/water").primaryColor("#4977f5").secondaryColor("#232b3d").tertiaryColor("#5e94e0").particleColor("#0b1e42").size(0.8).attributes(new HashMap<>(){{put("weather_tolerance", 2); }}).waterproof().noComb().flowerFluid("minecraft:water"));
            ...
            add(new BeeConfig("gems/agate").primaryColor("#9f01b8").secondaryColor("#064f2c").tertiaryColor("#c0138a").particleColor("#9f01b8").renderer("default_crystal").flowerTag("productivebees:flowers/agate").size(0.6).requireTag("forge:gems/agate").requireTag("productivebees:flowers/agate"));
            add(new BeeConfig("gems/alexandrite").primaryColor("#8d009a").secondaryColor("#2e0b17").tertiaryColor("#250028").particleColor("#8d009a").renderer("default_crystal").flowerTag("productivebees:flowers/alexandrite").size(0.6).requireTag("forge:gems/alexandrite").requireTag("productivebees:flowers/alexandrite"));
            add(new BeeConfig("gems/amber_gem").primaryColor("#fa9310").secondaryColor("#064f2c").tertiaryColor("#d4700e").particleColor("#fa9310").renderer("default_crystal").flowerTag("productivebees:flowers/amber").size(0.7).requireTag("forge:gems/amber").requireTag("productivebees:flowers/amber"));
            ...
            add(new BeeConfig("gems/ametrine").primaryColor("#98004c").secondaryColor("#2e0b17").tertiaryColor("#3d001f").particleColor("#98004c").renderer("default_crystal").flowerTag("productivebees:flowers/ametrine").size(0.6).requireTag("forge:gems/ametrine").requireTag("productivebees:flowers/ametrine"));
            add(new BeeConfig("gems/ammolite").primaryColor("#e4481f").secondaryColor("#3e5b68").tertiaryColor("#0900c9").particleColor("#e4481f").renderer("default_crystal").flowerTag("productivebees:flowers/ammolite").size(0.6).requireTag("forge:gems/ammolite").requireTag("productivebees:flowers/ammolite"));
            add(new BeeConfig("gems/apatite").primaryColor("#69ffff").secondaryColor("#3e5b68").tertiaryColor("#20afce").particleColor("#69ffff").renderer("default_crystal").flowerTag("productivebees:flowers/apatite").size(0.6).requireTag("forge:gems/apatite").requireTag("productivebees:flowers/apatite"));
            add(new BeeConfig("gems/aquamarine").primaryColor("#17cadd").secondaryColor("#064f2c").tertiaryColor("#007b70").particleColor("#17cadd").renderer("default_crystal").flowerTag("productivebees:flowers/aquamarine").size(0.6).requireTag("forge:gems/aquamarine").requireTag("productivebees:flowers/aquamarine"));
            add(new BeeConfig("gems/benitoite").primaryColor("#001bb6").secondaryColor("#2e0b17").tertiaryColor("#000c46").particleColor("#001bb6").renderer("default_crystal").flowerTag("productivebees:flowers/benitoite").size(0.6).requireTag("forge:gems/benitoite").requireTag("productivebees:flowers/benitoite"));
            add(new BeeConfig("gems/black_diamond").primaryColor("#636363").secondaryColor("#2e0b17").tertiaryColor("#141414").particleColor("#636363").renderer("default_crystal").flowerTag("productivebees:flowers/black_diamond").size(0.6).requireTag("forge:gems/black_diamond").requireTag("productivebees:flowers/black_diamond"));
            add(new BeeConfig("gems/black_opal").primaryColor("#636363").secondaryColor("#064f2c").tertiaryColor("#141414").particleColor("#636363").renderer("default_crystal").flowerTag("productivebees:flowers/black_opal").size(0.6).requireTag("forge:gems/black_opal").requireTag("productivebees:flowers/black_opal"));
            add(new BeeConfig("gems/carnelian").primaryColor("#d84e02").secondaryColor("#2e0b17").tertiaryColor("#340400").particleColor("#d84e02").renderer("default_crystal").flowerTag("productivebees:flowers/carnelian").size(0.6).requireTag("forge:gems/carnelian").requireTag("productivebees:flowers/carnelian"));
            add(new BeeConfig("gems/cats_eye").primaryColor("#ffe59e").secondaryColor("#3e5b68").tertiaryColor("#d59042").particleColor("#ffe59e").renderer("default_crystal").flowerTag("productivebees:flowers/cats_eye").size(0.6).requireTag("forge:gems/cats_eye").requireTag("productivebees:flowers/cats_eye"));
            add(new BeeConfig("gems/chrysoprase").primaryColor("#6cf631").secondaryColor("#3e5b68").tertiaryColor("#54943a").particleColor("#6cf631").renderer("default_crystal").flowerTag("productivebees:flowers/chrysoprase").size(0.6).requireTag("forge:gems/chrysoprase").requireTag("productivebees:flowers/chrysoprase"));add(new BeeConfig("gems/cinnabar").primaryColor("#d73e4a").secondaryColor("#710626").particleColor("#ff7883").flowerTag("forge:storage_blocks/cinnabar").size(0.6).requireTag("forge:gems/cinnabar").requireTag("forge:storage_blocks/cinnabar"));
            add(new BeeConfig("gems/citrine").primaryColor("#995500").secondaryColor("#2e0b17").tertiaryColor("#838f00").particleColor("#995500").renderer("default_crystal").flowerTag("productivebees:flowers/citrine").size(0.6).requireTag("forge:gems/citrine").requireTag("productivebees:flowers/citrine"));
            add(new BeeConfig("gems/coral").primaryColor("#ff732f").secondaryColor("#3e5b68").tertiaryColor("#dc1e4b").particleColor("#ff732f").renderer("default_crystal").flowerTag("productivebees:flowers/coral").size(0.6).requireTag("forge:gems/coral").requireTag("productivebees:flowers/coral"));add(new BeeConfig("gems/crystalline").primaryColor("#ede5dd").secondaryColor("#804f40").particleColor("#ede5dd").size(0.9).beeTexture("quartz").attributes(new HashMap<>(){{  put("endurance", 2); }}).flowerTag("productivebees:flowers/crystalline").nestingPreference("productivebees:nests/nether_quartz_nests").passiveEffects(new ArrayList<>() {{ add(new PassiveEffect("minecraft:resistance", 600)); }}));
            add(new BeeConfig("gems/crystalline").primaryColor("#ede5dd").secondaryColor("#804f40").particleColor("#ede5dd").size(0.9).beeTexture("quartz").attributes(new HashMap<>(){{  put("endurance", 2); }}).flowerTag("productivebees:flowers/crystalline").nestingPreference("productivebees:nests/nether_quartz_nests").passiveEffects(new ArrayList<>() {{ add(new PassiveEffect("minecraft:resistance", 600)); }}));
            add(new BeeConfig("gems/diamond").primaryColor("#3ddfe1").secondaryColor("#804f40").tertiaryColor("#0ebabd").particleColor("#3ddfe1").renderer("default_crystal").size(0.6).attributes(new HashMap<>(){{  put("endurance", 2); }}).flowerTag("productivebees:flowers/diamond"));
            ...
            add(new BeeConfig("gems/euclase").primaryColor("#005782").secondaryColor("#2e0b17").tertiaryColor("#001b28").particleColor("#005782").renderer("default_crystal").flowerTag("productivebees:flowers/euclase").size(0.6).requireTag("forge:gems/euclase").requireTag("productivebees:flowers/euclase"));
            add(new BeeConfig("gems/fluorite").primaryColor("#b9f3fa").secondaryColor("#1b2c33").tertiaryColor("#28a0b1").particleColor("#32e1f6").renderer("default_crystal").flowerTag("productivebees:flowers/fluorite").size(0.6).requireTag("forge:gems/fluorite").requireTag("productivebees:flowers/fluorite"));
            add(new BeeConfig("gems/garnet").primaryColor("#cc3516").secondaryColor("#064f2c").tertiaryColor("#dd3b17").particleColor("#cc3516").renderer("default_crystal").flowerTag("productivebees:flowers/garnet").size(0.6).requireTag("forge:gems/garnet").requireTag("productivebees:flowers/garnet"));
            add(new BeeConfig("gems/green_sapphire").primaryColor("#8adb18").secondaryColor("#064f2c").tertiaryColor("#019500").particleColor("#8adb18").renderer("default_crystal").flowerTag("productivebees:flowers/green_sapphire").size(0.6).requireTag("forge:gems/green_sapphire").requireTag("productivebees:flowers/green_sapphire"));
            add(new BeeConfig("gems/heliodor").primaryColor("#ddcf17").secondaryColor("#064f2c").tertiaryColor("#957b00").particleColor("#ddcf17").renderer("default_crystal").flowerTag("productivebees:flowers/heliodor").size(0.6).requireTag("forge:gems/heliodor").requireTag("productivebees:flowers/heliodor"));
            add(new BeeConfig("gems/iolite").primaryColor("#270070").secondaryColor("#2e0b17").tertiaryColor("#7000bd").particleColor("#270070").renderer("default_crystal").flowerTag("productivebees:flowers/iolite").size(0.6).requireTag("forge:gems/iolite").requireTag("productivebees:flowers/iolite"));
            add(new BeeConfig("gems/jade").primaryColor("#d6ff75").secondaryColor("#3e5b68").tertiaryColor("#b2e25d").particleColor("#d6ff75").renderer("default_crystal").flowerTag("productivebees:flowers/jade").size(0.6).requireTag("forge:gems/jade").requireTag("productivebees:flowers/jade"));
            add(new BeeConfig("gems/jasper").primaryColor("#342b00").secondaryColor("#2e0b17").tertiaryColor("#85794c").particleColor("#342b00").renderer("default_crystal").flowerTag("productivebees:flowers/jasper").size(0.6).requireTag("forge:gems/jasper").requireTag("productivebees:flowers/jasper"));
            add(new BeeConfig("gems/kunzite").primaryColor("#fe48ef").secondaryColor("#3e5b68").tertiaryColor("#93239e").particleColor("#fe48ef").renderer("default_crystal").flowerTag("productivebees:flowers/kunzite").size(0.6).requireTag("forge:gems/kunzite").requireTag("productivebees:flowers/kunzite"));
            add(new BeeConfig("gems/kyanite").primaryColor("#3b67ec").secondaryColor("#3e5b68").tertiaryColor("#0f4362").particleColor("#3b67ec").renderer("default_crystal").flowerTag("productivebees:flowers/kyanite").size(0.6).requireTag("forge:gems/kyanite").requireTag("productivebees:flowers/kyanite"));
            add(new BeeConfig("gems/lapis").primaryColor("#2659ab").secondaryColor("#804f40").tertiaryColor("#1b3588").particleColor("#3537bc").particleType("pop").renderer("default_crystal").noGlow().flowerTag("forge:storage_blocks/lapis").size(0.8));
            add(new BeeConfig("gems/lepidolite").primaryColor("#510046").secondaryColor("#2e0b17").tertiaryColor("#c812aa").particleColor("#510046").renderer("default_crystal").flowerTag("productivebees:flowers/lepidolite").size(0.6).requireTag("forge:gems/lepidolite").requireTag("productivebees:flowers/lepidolite"));
            add(new BeeConfig("gems/malachite").primaryColor("#22d946").secondaryColor("#2e0b17").tertiaryColor("#127625").particleColor("#22d946").renderer("default_crystal").flowerTag("productivebees:flowers/malachite").size(0.6).requireTag("forge:gems/malachite").requireTag("productivebees:flowers/malachite"));
            add(new BeeConfig("gems/moldavite").primaryColor("#b5bb05").secondaryColor("#2e0b17").tertiaryColor("#636e00").particleColor("#b5bb05").renderer("default_crystal").flowerTag("productivebees:flowers/moldavite").size(0.6).requireTag("forge:gems/moldavite").requireTag("productivebees:flowers/moldavite"));
            add(new BeeConfig("gems/moonstone").primaryColor("#e4e4e4").secondaryColor("#2e0b17").tertiaryColor("#b6b6b6").particleColor("#e4e4e4").renderer("default_crystal").flowerTag("productivebees:flowers/moonstone").size(0.6).requireTag("forge:gems/moonstone").requireTag("productivebees:flowers/moonstone"));
            add(new BeeConfig("gems/morganite").primaryColor("#ffbfc4").secondaryColor("#064f2c").tertiaryColor("#d67a91").particleColor("#ffbfc4").renderer("default_crystal").flowerTag("productivebees:flowers/morganite").size(0.6).requireTag("forge:gems/morganite").requireTag("productivebees:flowers/morganite"));
            add(new BeeConfig("gems/onyx").primaryColor("#383838").secondaryColor("#064f2c").tertiaryColor("#1f1f1f").particleColor("#383838").renderer("default_crystal").flowerTag("productivebees:flowers/onyx").size(0.6).requireTag("forge:gems/onyx").requireTag("productivebees:flowers/onyx"));
            add(new BeeConfig("gems/opal").primaryColor("#dbdbdb").secondaryColor("#064f2c").tertiaryColor("#8c8c8c").particleColor("#dbdbdb").renderer("default_crystal").flowerTag("productivebees:flowers/opal").size(0.6).requireTag("forge:gems/opal").requireTag("productivebees:flowers/opal"));
            add(new BeeConfig("gems/pearl").primaryColor("#a4b6d2").secondaryColor("#3e5b68").tertiaryColor("#7c95be").particleColor("#a4b6d2").renderer("default_crystal").flowerTag("productivebees:flowers/pearl").size(0.6).requireTag("forge:gems/pearl").requireTag("productivebees:flowers/pearl"));
            add(new BeeConfig("gems/peridot").primaryColor("#8adb18").secondaryColor("#064f2c").tertiaryColor("#5d7b00").particleColor("#8adb18").renderer("default_crystal").flowerTag("productivebees:flowers/peridot").size(0.6).requireTag("forge:gems/peridot").requireTag("productivebees:flowers/peridot"));
            add(new BeeConfig("gems/phosphophyllite").primaryColor("#18db8a").secondaryColor("#064f2c").tertiaryColor("#007b33").particleColor("#18db8a").renderer("default_crystal").flowerTag("productivebees:flowers/phosphophyllite").size(0.6).requireTag("forge:gems/phosphophyllite").requireTag("productivebees:flowers/phosphophyllite"));
            add(new BeeConfig("gems/pyrope").primaryColor("#bc1100").secondaryColor("#3e5b68").tertiaryColor("#620000").particleColor("#bc1100").renderer("default_crystal").flowerTag("productivebees:flowers/pyrope").size(0.6).requireTag("forge:gems/pyrope").requireTag("productivebees:flowers/pyrope"));
            ...
            add(new BeeConfig("gems/ruby").primaryColor("#c62415").secondaryColor("#064f2c").tertiaryColor("#7b000b").particleColor("#c62415").renderer("default_crystal").flowerTag("productivebees:flowers/ruby").size(0.6).requireTag("forge:gems/ruby").requireTag("productivebees:flowers/ruby"));add(new BeeConfig("gems/sapphire").primaryColor("#5241f3").secondaryColor("#064f2c").tertiaryColor("#000b7b").particleColor("#5241f3").renderer("default_crystal").flowerTag("productivebees:flowers/sapphire").size(0.6).requireTag("forge:gems/sapphire").requireTag("productivebees:flowers/sapphire"));
            add(new BeeConfig("gems/sapphire").primaryColor("#5241f3").secondaryColor("#064f2c").tertiaryColor("#000b7b").particleColor("#5241f3").renderer("default_crystal").flowerTag("productivebees:flowers/sapphire").size(0.6).requireTag("forge:gems/sapphire").requireTag("productivebees:flowers/sapphire"));
            add(new BeeConfig("gems/sodalite").primaryColor("#4c4bff").secondaryColor("#3e5b68").tertiaryColor("#23389e").particleColor("#4c4bff").renderer("default_crystal").flowerTag("productivebees:flowers/sodalite").size(0.6).requireTag("forge:gems/sodalite"));
            add(new BeeConfig("gems/spinel").primaryColor("#741200").secondaryColor("#2e0b17").tertiaryColor("#c25500").particleColor("#741200").renderer("default_crystal").flowerTag("productivebees:flowers/spinel").size(0.6).requireTag("forge:gems/spinel").requireTag("productivebees:flowers/spinel"));
            add(new BeeConfig("gems/sunstone").primaryColor("#ffcab0").secondaryColor("#3e5b68").tertiaryColor("#d45241").particleColor("#ffcab0").renderer("default_crystal").flowerTag("productivebees:flowers/sunstone").size(0.6).requireTag("forge:gems/sunstone").requireTag("productivebees:flowers/sunstone"));
            add(new BeeConfig("gems/tanzanite").primaryColor("#a66ef4").secondaryColor("#064f2c").tertiaryColor("#3500aa").particleColor("#a66ef4").renderer("default_crystal").flowerTag("productivebees:flowers/tanzanite").size(0.6).requireTag("forge:gems/tanzanite").requireTag("productivebees:flowers/tanzanite"));
            add(new BeeConfig("gems/tektite").primaryColor("#978574").secondaryColor("#3e5b68").tertiaryColor("#725e4c").particleColor("#978574").renderer("default_crystal").flowerTag("productivebees:flowers/tektite").size(0.6).requireTag("forge:gems/tektite").requireTag("productivebees:flowers/tektite"));
            add(new BeeConfig("gems/topaz").primaryColor("#dd7d17").secondaryColor("#064f2c").tertiaryColor("#dd7d17").particleColor("#dd7d17").renderer("default_crystal").flowerTag("productivebees:flowers/topaz").size(0.6).requireTag("forge:gems/topaz").requireTag("productivebees:flowers/topaz"));
            add(new BeeConfig("gems/turquoise").primaryColor("#24daac").secondaryColor("#2e0b17").tertiaryColor("#19ac80").particleColor("#24daac").renderer("default_crystal").flowerTag("productivebees:flowers/turquoise").size(0.6).requireTag("forge:gems/turquoise").requireTag("productivebees:flowers/turquoise"));
            add(new BeeConfig("gems/tourmaline").primaryColor("#ee2386").secondaryColor("#3e5b68").tertiaryColor("#8a2457").particleColor("#ee2386").renderer("default_crystal").flowerTag("productivebees:flowers/tourmaline").size(0.6).requireTag("forge:gems/tourmaline").requireTag("productivebees:flowers/tourmaline"));add(new BeeConfig("gems/turquoise").primaryColor("#24daac").secondaryColor("#2e0b17").tertiaryColor("#19ac80").particleColor("#24daac").renderer("default_crystal").flowerTag("productivebees:flowers/turquoise").size(0.6).requireTag("forge:gems/turquoise").requireTag("productivebees:flowers/turquoise"));
            add(new BeeConfig("gems/white_diamond").primaryColor("#fff9e4").secondaryColor("#f7ed91").tertiaryColor("#c5b520").particleColor("#fff9e4").renderer("default_crystal").flowerTag("productivebees:flowers/white_diamond").size(0.6).requireTag("forge:gems/white_diamond").requireTag("productivebees:flowers/white_diamond"));
            add(new BeeConfig("gems/zircon").primaryColor("#787800").secondaryColor("#2e0b17").tertiaryColor("#b3b600").particleColor("#787800").renderer("default_crystal").flowerTag("productivebees:flowers/zircon").size(0.6).requireTag("forge:gems/zircon").requireTag("productivebees:flowers/zircon"));
            ...
            add(new BeeConfig("gtceu/barite").primaryColor("#836c43").secondaryColor("#d8d2c2").tertiaryColor("#57411a").particleColor("#e5dfcf").beeTexture("barite").size(0.8).onlySpawnegg().flowerTag("forge:storage_blocks/raw_barite").noSelfBreed().requireMod("gtceu"));
            add(new BeeConfig("gtceu/bastnasite").primaryColor("#743b21").secondaryColor("#ab904e").tertiaryColor("#a77742").particleColor("#c7a85e").beeTexture("bastnasite").size(0.8).onlySpawnegg().flowerTag("forge:storage_blocks/raw_bastnasite").noSelfBreed().requireMod("gtceu"));
            add(new BeeConfig("gtceu/bauxite").primaryColor("#965425").secondaryColor("#cdaa52").tertiaryColor("#450a04").particleColor("#cdaa52").beeTexture("bauxite").size(0.8).onlySpawnegg().flowerTag("forge:storage_blocks/raw_bauxite").noSelfBreed().requireMod("gtceu"));
            add(new BeeConfig("gtceu/chromite").primaryColor("#554256").secondaryColor("#b4b09a").tertiaryColor("#8d7c85").particleColor("#c3bfa6").beeTexture("chromite").size(0.8).flowerTag("forge:storage_blocks/raw_chromite").onlySpawnegg().noSelfBreed().requireMod("gtceu"));
            add(new BeeConfig("gtceu/cobaltite").primaryColor("#184ddf").secondaryColor("#3d8bff").tertiaryColor("#262556").particleColor("#3d8bff").beeTexture("cobaltite").size(0.8).onlySpawnegg().flowerTag("forge:storage_blocks/raw_cobaltite").noSelfBreed().requireMod("gtceu"));
            add(new BeeConfig("gtceu/electrotine").primaryColor("#1a4568").secondaryColor("#7dc1ea").tertiaryColor("#001c36").particleColor("#e3f0f8").beeTexture("electrotine").size(0.8).onlySpawnegg().flowerTag("forge:storage_blocks/raw_electrotine").noSelfBreed().requireMod("gtceu"));
            add(new BeeConfig("gtceu/galena").primaryColor("#2c2034").secondaryColor("#ded4e5").tertiaryColor("#5a4f61").particleColor("#f0e5f7").beeTexture("galena").size(0.8).onlySpawnegg().flowerTag("forge:storage_blocks/raw_galena").noSelfBreed().requireMod("gtceu"));
            add(new BeeConfig("gtceu/graphite").primaryColor("#1b2012").secondaryColor("#77796d").tertiaryColor("#4a4e40").particleColor("#a6a69c").beeTexture("graphite").size(0.8).onlySpawnegg().flowerTag("forge:storage_blocks/raw_graphite").noSelfBreed().requireMod("gtceu"));
            add(new BeeConfig("gtceu/ilmenite").primaryColor("#171006").secondaryColor("#2a2924").tertiaryColor("#251a0d").particleColor("#28251e").beeTexture("ilmenite").size(0.8).onlySpawnegg().flowerTag("forge:storage_blocks/raw_ilmenite").noSelfBreed().requireMod("gtceu"));
            add(new BeeConfig("gtceu/lepidolite").primaryColor("#573750").secondaryColor("#e1c6d2").tertiaryColor("#774d67").particleColor("#fbd7e0").beeTexture("lepidolite").size(0.8).onlySpawnegg().flowerTag("forge:storage_blocks/raw_lepidolite").noSelfBreed().requireMod("gtceu"));
            add(new BeeConfig("gtceu/molybdenum").primaryColor("#7e80a5").particleColor("#a7a8c3").beeTexture("molybdenum").size(0.8).onlySpawnegg().flowerTag("forge:storage_blocks/molybdenum").noSelfBreed().requireMod("gtceu").requireTag("forge:raw_materials/molybdenum"));
            ...
            add(new BeeConfig("gtceu/neodymium").primaryColor("#998784").particleColor("#ab9d9a").beeTexture("neodymium").size(0.8).onlySpawnegg().flowerTag("forge:storage_blocks/neodymium").noSelfBreed().requireMod("gtceu").requireTag("forge:raw_materials/neodymium"));
            add(new BeeConfig("gtceu/neutronium").primaryColor("#272727").secondaryColor("#383838").tertiaryColor("#b3b3b3").particleColor("#dcdcdc").beeTexture("neutronium").size(1).flowerTag("forge:storage_blocks/neutronium").noSelfBreed().requireMod("gtceu"));
            ...
            add(new BeeConfig("gtceu/palladium").primaryColor("#b78187").particleColor("#c3989a").beeTexture("palladium").size(0.8).onlySpawnegg().flowerTag("forge:storage_blocks/palladium").noSelfBreed().requireMod("gtceu").requireTag("forge:raw_materials/palladium"));
            add(new BeeConfig("gtceu/pyrochlore").primaryColor("#2b1a0d").secondaryColor("#4a3929").tertiaryColor("#2c1c10").particleColor("#5a4737").beeTexture("pyrochlore").size(0.8).onlySpawnegg().flowerTag("forge:storage_blocks/raw_pyrochlore").noSelfBreed().requireMod("gtceu"));
            add(new BeeConfig("gtceu/pyrolusite").primaryColor("#5b5551").secondaryColor("#b9a89f").tertiaryColor("#353231").particleColor("#c5b3a9").beeTexture("pyrolusite").size(0.8).flowerTag("forge:storage_blocks/raw_pyrolusite").onlySpawnegg().noSelfBreed().requireMod("gtceu"));
            add(new BeeConfig("gtceu/realgar").primaryColor("#35080b").secondaryColor("#d5312b").tertiaryColor("#470d0f").particleColor("#fc3c32").beeTexture("realgar").size(0.8).flowerTag("forge:storage_blocks/realgar").noSelfBreed().requireMod("gtceu"));
            add(new BeeConfig("gtceu/scheelite").primaryColor("#24365d").secondaryColor("#c8d8a6").tertiaryColor("#93a9ad").particleColor("#d4e5b1").beeTexture("scheelite").size(0.8).onlySpawnegg().flowerTag("forge:storage_blocks/raw_scheelite").noSelfBreed().requireMod("gtceu"));
            add(new BeeConfig("gtceu/sheldonite").primaryColor("#4d4f2e").secondaryColor("#d5e999").tertiaryColor("#8f9961").particleColor("#e6fca5").beeTexture("sheldonite").size(0.8).onlySpawnegg().flowerTag("forge:storage_blocks/raw_cooperite").noSelfBreed().requireMod("gtceu"));
            add(new BeeConfig("gtceu/sphalerite").primaryColor("#4a4326").secondaryColor("#edcd7e").tertiaryColor("#8d7c4a").particleColor("#fcd986").beeTexture("sphalerite").size(0.8).onlySpawnegg().flowerTag("forge:storage_blocks/raw_sphalerite").noSelfBreed().requireMod("gtceu"));
            add(new BeeConfig("gtceu/stibnite").primaryColor("#141824").secondaryColor("#646464").tertiaryColor("#363840").particleColor("#7d7c7c").beeTexture("stibnite").size(0.8).onlySpawnegg().flowerTag("forge:storage_blocks/raw_stibnite").noSelfBreed().requireMod("gtceu"));
            add(new BeeConfig("gtceu/tantalite").primaryColor("#291206").secondaryColor("#476287").tertiaryColor("#514444").particleColor("#4d6a92").beeTexture("tantalite").size(0.8).onlySpawnegg().flowerTag("forge:storage_blocks/raw_tantalite").noSelfBreed().requireMod("gtceu"));
            add(new BeeConfig("gtceu/tetrahedrite").primaryColor("#273125").secondaryColor("#7d7f77").tertiaryColor("#474f44").particleColor("#a19e99").beeTexture("tetrahedrite").size(0.8).onlySpawnegg().flowerTag("forge:storage_blocks/raw_tetrahedrite").noSelfBreed().requireMod("gtceu"));
            add(new BeeConfig("gtceu/tricalcium_phosphate").primaryColor("#94941e").secondaryColor("#dfde97").tertiaryColor("#bebd49").particleColor("#fbf9d8").beeTexture("tricalcium_phosphate").size(0.8).onlySpawnegg().flowerTag("forge:storage_blocks/raw_tricalcium_phosphate").noSelfBreed().requireMod("gtceu"));
            add(new BeeConfig("gtceu/tungstate").primaryColor("#6e4824").secondaryColor("#bfc893").tertiaryColor("#725531").particleColor("#ddfcc2").beeTexture("tungstate").size(0.8).onlySpawnegg().flowerTag("forge:storage_blocks/raw_tungstate").noSelfBreed().requireMod("gtceu"));
            add(new BeeConfig("gtceu/vanadium_magnetite").primaryColor("#201a27").secondaryColor("#7e8794").tertiaryColor("#5c5d6d").particleColor("#8892a0").beeTexture("vanadium_magnetite").size(0.8).onlySpawnegg().flowerTag("forge:storage_blocks/raw_vanadium_magnetite").noSelfBreed().requireMod("gtceu"));

            add(new BeeConfig("iceandfire/fire_dragonsteel").primaryColor("#c08787").secondaryColor("#3d1316").particleColor("#524853").onlySpawnegg().renderer("thicc").size(1.2).attributes(new HashMap<>(){{  put("endurance", 3);  put("productivity", 1); }}).flowerBlock("iceandfire:dragonsteel_fire_block").requireMod("iceandfire"));
            add(new BeeConfig("iceandfire/ice_dragonsteel").primaryColor("#c0e3f6").secondaryColor("#323234").particleColor("#fcfcfc").onlySpawnegg().renderer("thicc").size(1.2).attributes(new HashMap<>(){{  put("endurance", 3);  put("productivity", 1); }}).flowerBlock("iceandfire:dragonsteel_ice_block").requireMod("iceandfire"));
            add(new BeeConfig("iceandfire/lightning_dragonsteel").primaryColor("#4d3e7c").secondaryColor("#9177ae").particleColor("#8471a0").onlySpawnegg().renderer("thicc").size(1.2).attributes(new HashMap<>(){{  put("endurance", 3);  put("productivity", 1); }}).flowerBlock("iceandfire:dragonsteel_lightning_block").requireMod("iceandfire"));
            ...
            add(new BeeConfig("industrialforegoing/ether_gas").primaryColor("#9ad7e3").secondaryColor("#70b4c2").particleColor("#b5f3ff").beeTexture("ether_gas").renderer("translucent_with_center").size(0.5).flowerTag("forge:withers").flowerType("entity_types").noSelfBreed().requireMod("industrialforegoing"));
            add(new BeeConfig("industrialforegoing/pink_slimy").primaryColor("#b969ba").secondaryColor("#6238757").particleColor("#c98bca").beeTexture("pink_slimy").renderer("translucent_with_center").attributes(new HashMap<>(){{  put("productivity", 0); }}).slimy().flowerTag("productivebees:flowers/swamp_flowers").nestingPreference("productivebees:nests/slimy_nests").requireFluidTag("forge:pink_slime"));

            add(new BeeConfig("integrateddynamics/menril").primaryColor("#5a7088").secondaryColor("#804f40").particleColor("#5a7088").requireMod("integrateddynamics"));
            ...
            add(new BeeConfig("occultism/iesnium").primaryColor("#52a0ae").secondaryColor("#8ecbce").particleColor("#3c8794").flowerTag("forge:storage_blocks/iesnium").onlySpawnegg().requireTag("forge:storage_blocks/iesnium"));
            ...
            add(new BeeConfig("pokecube/cosmic_dust").primaryColor("#2394cc").secondaryColor("#0f0f66").particleColor("#2394cc").flowerTag("forge:ores/cosmic").requireTag("forge:gems/cosmicdust").requireTag("forge:ores/cosmic"));
            add(new BeeConfig("pokecube/spectrum").primaryColor("#ffc9a7").secondaryColor("#ff762c").particleColor("#ffc9a7").flowerTag("forge:storage_blocks/spectrum").requireTag("forge:gems/spectrum").requireTag("forge:storage_blocks/spectrum"));
            ...
            add(new BeeConfig("powah/energized_steel").primaryColor("#bfb49d").secondaryColor("#7d7565").flowerBlock("powah:energized_steel_block").requireMod("powah"));
            add(new BeeConfig("powah/niotic_crystal").primaryColor("#1dc1f2").secondaryColor("#1b86a6").flowerBlock("powah:niotic_crystal_block").requireMod("powah"));
            add(new BeeConfig("powah/nitro_crystal").primaryColor("#e33917").secondaryColor("#b3280c").flowerBlock("powah:nitro_crystal_block").noSelfBreed().requireMod("powah"));
            add(new BeeConfig("powah/spirited_crystal").primaryColor("#7cff1f").secondaryColor("#61bf1f").flowerBlock("powah:spirited_crystal_block").noSelfBreed().requireMod("powah"));
            add(new BeeConfig("powah/uraninite").primaryColor("#00FF00").secondaryColor("#008000").particleColor("#7CFC00").size(0.8).flowerTag("forge:storage_blocks/uraninite").requireMod("powah").requireTag("forge:storage_blocks/uraninite"));

            add(new BeeConfig("raw_materials/aluminum").primaryColor("#A4A6B1").secondaryColor("#804f40").flowerTag("forge:storage_blocks/aluminum").requireTag("forge:storage_blocks/aluminum"));
            add(new BeeConfig("raw_materials/bismuth").primaryColor("#ece386").secondaryColor("#586bb7").particleColor("#b598db").flowerTag("forge:storage_blocks/bismuth").requireTag("forge:storage_blocks/bismuth"));
            add(new BeeConfig("raw_materials/copper").primaryColor("#F48702").secondaryColor("#804f40").flowerTag("productivebees:flowers/cupric_flowers"));
            add(new BeeConfig("raw_materials/gold").primaryColor("#FCD979").secondaryColor("#804f40").particleColor("#fffd6e").flowerTag("productivebees:flowers/gilded_flowers").attributes(new HashMap<>(){{  put("endurance", 0); }}));
            add(new BeeConfig("raw_materials/iridium").primaryColor("#ffccff").secondaryColor("#d4e4fc").particleColor("#8c9fac").flowerTag("forge:storage_blocks/iridium").size(0.8).requireTag("forge:storage_blocks/iridium"));
            add(new BeeConfig("raw_materials/iron").primaryColor("#cdcdcd").secondaryColor("#804f40").particleColor("#b6b6b6").flowerTag("productivebees:flowers/ferric_flowers"));
            add(new BeeConfig("raw_materials/lead").primaryColor("#677193").secondaryColor("#804f40").flowerTag("forge:storage_blocks/lead").requireTag("forge:storage_blocks/lead"));
            add(new BeeConfig("raw_materials/netherite").primaryColor("#4d494d").secondaryColor("#804f40").particleColor("#4d494d").flowerTag("forge:storage_blocks/netherite").size(0.7).attributes(new HashMap<>(){{  put("endurance", 2); }}).attackResponse("fire").fireproof().withered());
            add(new BeeConfig("raw_materials/nickel").primaryColor("#D8CC93").secondaryColor("#804f40").flowerTag("forge:storage_blocks/nickel").requireTag("forge:storage_blocks/nickel"));
            add(new BeeConfig("raw_materials/osmium").primaryColor("#4c9db6").secondaryColor("#804f40").flowerTag("forge:storage_blocks/osmium").requireTag("forge:storage_blocks/osmium"));
            add(new BeeConfig("raw_materials/platinum").primaryColor("#6FEAEF").secondaryColor("#804f40").attributes(new HashMap<>(){{  put("endurance", 2); }}).flowerTag("forge:storage_blocks/platinum").requireTag("forge:storage_blocks/platinum"));
            ...
            add(new BeeConfig("raw_materials/silver").primaryColor("#A9DBE5").secondaryColor("#804f40").flowerTag("forge:storage_blocks/silver").requireTag("forge:storage_blocks/silver"));
            add(new BeeConfig("raw_materials/tin").primaryColor("#9ABDD6").secondaryColor("#804f40").flowerTag("forge:storage_blocks/tin").requireTag("forge:storage_blocks/tin"));
            add(new BeeConfig("raw_materials/titanium").primaryColor("#D0D1DA").secondaryColor("#804f40").flowerTag("forge:storage_blocks/titanium").requireTag("forge:storage_blocks/titanium"));
            add(new BeeConfig("raw_materials/tungsten").primaryColor("#616669").secondaryColor("#804f40").flowerTag("forge:storage_blocks/tungsten").requireTag("forge:storage_blocks/tungsten"));
            add(new BeeConfig("raw_materials/zinc").primaryColor("#E9EBE7").secondaryColor("#804f40").flowerTag("forge:storage_blocks/zinc").requireTag("forge:storage_blocks/zinc"));
            add(new BeeConfig("raw_materials/mithril").primaryColor("#0b2638").secondaryColor("#0e6a61").particleColor("#92e7ae").flowerTag("forge:storage_blocks/mithril").beeTexture("mithril").requireTag("forge:storage_blocks/mithril"));

            add(new BeeConfig("reactors/blutonium").primaryColor("#1929d4").secondaryColor("#0c1899").particleColor("#2b38bd").size(0.8).flowerTag("forge:storage_blocks/blutonium").onlySpawnegg().requireTag("forge:storage_blocks/blutonium"));
            add(new BeeConfig("reactors/cyanite").primaryColor("#72c2d4").secondaryColor("#60b2c4").particleColor("#92c6d1").size(0.8).flowerTag("forge:storage_blocks/cyanite").requireTag("forge:storage_blocks/cyanite"));
            add(new BeeConfig("reactors/graphite").primaryColor("#1b2012").secondaryColor("#77796d").tertiaryColor("#4a4e40").particleColor("#a6a69c").beeTexture("graphite").size(0.8).flowerTag("forge:storage_blocks/graphite").noSelfBreed().missingMod("gtceu"));
            add(new BeeConfig("reactors/inanite").primaryColor("#bd0d62").secondaryColor("#db046c").particleColor("#ed2b89").size(0.8).flowerTag("forge:storage_blocks/inanite").noSelfBreed().onlySpawnegg().requireTag("forge:storage_blocks/inanite"));
            add(new BeeConfig("reactors/insanite").primaryColor("#1eeb96").secondaryColor("#16c97f").particleColor("#37de99").size(0.8).flowerTag("forge:storage_blocks/insanite").noSelfBreed().onlySpawnegg().requireTag("forge:storage_blocks/insanite"));
            add(new BeeConfig("reactors/ludicrite").primaryColor("#7d10b0").secondaryColor("#8f21c2").particleColor("#ad5bd4").size(0.8).flowerTag("forge:storage_blocks/ludicrite").noSelfBreed().onlySpawnegg().requireTag("forge:storage_blocks/ludicrite"));
            add(new BeeConfig("reactors/magentite").primaryColor("#c418c9").secondaryColor("#970c9c").particleColor("#da6fde").size(0.8).flowerTag("forge:storage_blocks/magentite").requireTag("forge:storage_blocks/magentite"));
            add(new BeeConfig("reactors/ridiculite").primaryColor("#e2ace8").secondaryColor("#ba8abf").particleColor("#dcb4e0").size(0.8).flowerTag("forge:storage_blocks/ridiculite").noSelfBreed().onlySpawnegg().requireTag("forge:storage_blocks/ridiculite"));
            ...
            add(new BeeConfig("shroom/crimson").primaryColor("#6e1917").secondaryColor("#2f0d06").tertiaryColor("#913000").particleColor("#913000").flowerBlock("minecraft:crimson_fungus").renderer("default_foliage").size(0.5).breedingItem("minecraft:crimson_fungus").attributes(new HashMap<>(){{ put("behavior", 1); }}));
            ...
            add(new BeeConfig("shroom/warped").primaryColor("#0c6138").secondaryColor("#0c3326").tertiaryColor("#9a562c").particleColor("#9a3600").flowerBlock("minecraft:warped_fungus").renderer("default_foliage").size(0.5).breedingItem("minecraft:warped_fungus").attributes(new HashMap<>(){{ put("behavior", 1); }}));
            ...
            add(new BeeConfig("tconstruct/amethyst_bronze").primaryColor("#C687BD").secondaryColor("#7a5800").particleColor("#C687BD").onlySpawnegg().flowerTag("forge:storage_blocks/amethyst_bronze").requireTag("forge:storage_blocks/amethyst_bronze"));
            add(new BeeConfig("tconstruct/cobalt").primaryColor("#1d77eb").secondaryColor("#0c5abe").particleColor("#1d77eb").onlySpawnegg().flowerTag("forge:storage_blocks/cobalt").requireTag("forge:storage_blocks/cobalt"));
            add(new BeeConfig("tconstruct/ender_slimy").primaryColor("#d17bfc").secondaryColor("#6200ae").particleColor("#d17bfc").beeTexture("ender_slimy").onlySpawnegg().renderer("translucent_with_center").requireTag("forge:slimeball/ender"));
            add(new BeeConfig("tconstruct/hepatizon").primaryColor("#675072").secondaryColor("#1b0426").particleColor("#675072").onlySpawnegg().flowerTag("forge:storage_blocks/hepatizon").requireTag("forge:storage_blocks/hepatizon"));
            add(new BeeConfig("tconstruct/ichor_slimy").primaryColor("#fcb77b").secondaryColor("#ae3f00").particleColor("#fcb77b").beeTexture("ichor_slimy").onlySpawnegg().renderer("translucent_with_center").requireTag("forge:slimeball/ichor"));
            add(new BeeConfig("tconstruct/knightslime").primaryColor("#c882f5").secondaryColor("#804f40").particleColor("#c882f5").onlySpawnegg().flowerTag("forge:storage_blocks/knightslime").requireTag("forge:storage_blocks/knightslime"));
            add(new BeeConfig("tconstruct/manyullyn").primaryColor("#ab6cd7").secondaryColor("#652e87").particleColor("#ab6cd7").onlySpawnegg().flowerTag("forge:storage_blocks/manyullyn").requireTag("forge:storage_blocks/manyullyn"));
            add(new BeeConfig("tconstruct/pig_iron").primaryColor("#dbaaa9").secondaryColor("#804f40").particleColor("#dbaaa9").onlySpawnegg().flowerTag("forge:storage_blocks/pig_iron").requireTag("forge:storage_blocks/pig_iron"));
            add(new BeeConfig("tconstruct/queens_slime").primaryColor("#267049").secondaryColor("#204c49").particleColor("#267049").onlySpawnegg().flowerTag("forge:storage_blocks/queens_slime").requireTag("forge:storage_blocks/queens_slime"));
            add(new BeeConfig("tconstruct/rose_gold").primaryColor("#eeb9a0").secondaryColor("#804f40").particleColor("#eeb9a0").onlySpawnegg().flowerTag("forge:storage_blocks/rose_gold").requireTag("forge:storage_blocks/rose_gold"));
            add(new BeeConfig("tconstruct/sky_slime").primaryColor("#80d4d2").secondaryColor("#2e5250").particleColor("#80d4d2").beeTexture("sky_slimy").onlySpawnegg().renderer("translucent_with_center").requireTag("forge:slimeball/sky"));
            add(new BeeConfig("tconstruct/slimesteel").primaryColor("#7ae7e0").secondaryColor("#73d2dc").particleColor("#7ae7e0").onlySpawnegg().flowerTag("forge:storage_blocks/slimesteel").requireTag("forge:storage_blocks/slimesteel"));
            add(new BeeConfig("tconstruct/soulsteel").primaryColor("#5c4436").secondaryColor("#1f0700").particleColor("#5c4436").onlySpawnegg().flowerTag("forge:storage_blocks/soulsteel").requireTag("forge:storage_blocks/soulsteel"));
            ...
            add(new BeeConfig("thermal/blitz").primaryColor("#e9edf3").secondaryColor("#bdccd9").particleColor("#ffd86f").onlySpawnegg().beeTexture("blitz").flowerBlock("thermal:niter_block").attributes(new HashMap<>(){{  put("weather_tolerance", 2); }}).requireMod("thermal"));
            ...
            add(new BeeConfig("thermal/resonant_ender").primaryColor("#161616").secondaryColor("#6238757").particleColor("#cc00fa").particleType("portal").size(0.8).onlySpawnegg().flowerTag("productivebees:flowers/ender").teleporting().requireMod("thermal"));

            add(new BeeConfig("thermalendergy/melodium").primaryColor("#523a8b").secondaryColor("#b390f4").particleColor("#fcd9ea").size(0.5).beeTexture("melodium").onlySpawnegg().noSelfBreed().flowerTag("forge:storage_blocks/melodium").requireTag("forge:storage_blocks/melodium"));
            add(new BeeConfig("thermalendergy/stellarium").primaryColor("#1e2626").secondaryColor("#728e8e").particleColor("#deeaea").size(0.3).beeTexture("stellarium").onlySpawnegg().noSelfBreed().flowerTag("forge:storage_blocks/stellarium").requireTag("forge:storage_blocks/stellarium"));
            add(new BeeConfig("thermalendergy/prismalium").primaryColor("#43806e").secondaryColor("#9fe1cb").particleColor("#f7fdfd").size(0.7).beeTexture("prismalium").flowerTag("forge:storage_blocks/prismalium").requireTag("forge:storage_blocks/prismalium"));
