...
public class BeeProvider implements DataProvider
{
    ...
    protected List<BeeConfig> getBeeConfigs() {
        return new ArrayList<>() {{
            ...
            add(new BeeConfig("wanna").primaryColor("#3b2754").secondaryColor("#06030b").particleColor("#3b2754").beeTexture("wanna").renderer("thicc").noComb().onlySpawnegg().attributes(new HashMap<>(){{ put("endurance", GeneValue.ENDURANCE_STRONG.getSerializedName()); }}).flowerBlock("productivebees:amber").onlySpawnegg().breedingItem("minecraft:disc_fragment_5"));
            ...
            add(new BeeConfig("ars_nouveau/earth_essence").primaryColor("#7ae54c").secondaryColor("#01de07").tertiaryColor("#007702").onlySpawnegg().renderer("default_crystal").size(0.7).flowerItem("ars_nouveau:earth_essence").beeTexture("earth_essence").particleType("pop").noSelfBreed().requireMod("ars_nouveau"));
            add(new BeeConfig("ars_nouveau/fire_essence").primaryColor("#ad0f07").secondaryColor("#ed5302").tertiaryColor("#fa8a78").onlySpawnegg().renderer("default_crystal").size(0.7).flowerItem("ars_nouveau:fire_essence").beeTexture("fire_essence").particleType("pop").noSelfBreed().requireMod("ars_nouveau"));
            add(new BeeConfig("ars_nouveau/water_essence").primaryColor("#2e35f0").secondaryColor("#60c7ed").tertiaryColor("#b5f2ff").onlySpawnegg().renderer("default_crystal").size(0.7).flowerItem("ars_nouveau:water_essence").beeTexture("water_essence").particleType("pop").noSelfBreed().requireMod("ars_nouveau"));
            ...
            add(new BeeConfig("create_enchantment_industry/super_experience").primaryColor("#3fcbff").secondaryColor("#5698db").tertiaryColor("#b0cdeb").particleColor("#a1d0ff").beeTexture("super_experience").size(0.6).flowerBlock("create_enchantment_industry:super_experience_block").noSelfBreed().requireMod("create_enchantment_industry"));
            ...
            add(new BeeConfig("oritech/sheol_fire").primaryColor("#de6417").secondaryColor("#4e0017").tertiaryColor("#64080f").particleColor("#f48a47").flowerFluid("oritech:still_sheol_fire").beeTexture("sheol_fire").size(0.7).noSelfBreed().renderer("default_shell").requireMod("oritech"));
            ...
            add(new BeeConfig("refinedstorage/quartz_enriched_iron").primaryColor("#c9c7c2").secondaryColor("#4f4e4b").particleColor("#c9c7c2").size(1.0).flowerBlock("refinedstorage:machine_casing").requireMod("refinedstorage"));

            add(new BeeConfig("rftools/dimensional_shard").primaryColor("#c1fcfa").secondaryColor("#5ea8a6").particleColor("#ebfcfa").tertiaryColor("#218887").size(0.7).flowerBlock("rftoolsbase:dimensionalshard_overworld").renderer("default_crystal").beeTexture("dimensional_shard").requireMod("rftoolsbase"));
