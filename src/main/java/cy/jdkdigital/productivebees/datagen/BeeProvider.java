...
public class BeeProvider implements DataProvider
{
    ...
    protected List<BeeConfig> getBeeConfigs() {
        return new ArrayList<>() {{
            ...
            add(new BeeConfig("coal").primaryColor("#222525").secondaryColor("#804f40").particleColor("#222525").flowerTag("c:storage_blocks/coal").size(0.5));
            ...
            add(new BeeConfig("ender").primaryColor("#161616").secondaryColor("#623875").particleColor("#cc00fa").particleType("portal").size(0.8).beeTexture("ender").attributes(new HashMap<>(){{ put("endurance", 1); }}).teleporting().flowerTag("productivebees:flowers/ender").nestingPreference("productivebees:nests/end_nests"));
            add(new BeeConfig("experience").primaryColor("#00fc1a").secondaryColor("#884739").particleColor("#00fc1a").flowerTag("c:bookshelves"));
            ...
            add(new BeeConfig("ghostly").primaryColor("#eeeeee").beeTexture("ghostly").translucent().noComb().attributes(new HashMap<>(){{ put("behavior", 1); }}).flowerTag("productivebees:flowers/souled").nestingPreference("productivebees:nests/soul_sand_nests"));
            ...
            add(new BeeConfig("obsidian").primaryColor("#3b2754").secondaryColor("#06030b").particleColor("#3b2754").renderer("thicc").size(0.85).attributes(new HashMap<>(){{  put("endurance", 3); }}).flowerTag("c:obsidian"));
            ...
            add(new BeeConfig("sculk").primaryColor("#141414").secondaryColor("#141414").particleColor("#141414").beeTexture("sculk").noSelfBreed().flowerBlock("minecraft:sculk_shrieker").attributes(new HashMap<>(){{  put("temper", 2);  put("behavior", 1); }}).passiveEffects(new ArrayList<>() {{ add(new PassiveEffect("minecraft:darkness", 60)); }}));
            ...
            add(new BeeConfig("skeletal").primaryColor("#c1c1c1").secondaryColor("#c1c1c1").beeTexture("skeletal").noSelfBreed().flowerBlock("minecraft:bone_block").attributes(new HashMap<>(){{ put("behavior", 1); }}));
            add(new BeeConfig("slimy").primaryColor("#2ff757").secondaryColor("#623875").particleColor("#2ff757").beeTexture("slimy").renderer("translucent_with_center").attributes(new HashMap<>(){{ put("temper", 0); }}).slimy().flowerTag("productivebees:flowers/swamp").nestingPreference("productivebees:nests/slimy_nests"));
            ...
            add(new BeeConfig("sugarbag").primaryColor("#000000").secondaryColor("#623875").particleColor("#99bf02").beeTexture("sugarbag").flowerBlock("minecraft:sugar_cane").noComb().renderer("tiny").attributes(new HashMap<>(){{  put("temper", 0); }}).stingless().nestingPreference("productivebees:nests/sugarbag_nests"));
            ...
            add(new BeeConfig("withered").primaryColor("#141414").secondaryColor("#141414").particleColor("#141414").beeTexture("wither").noSelfBreed().flowerTag("productivebees:flowers/wither").attributes(new HashMap<>(){{  put("temper", 2); put("behavior", 1); }}).withered().passiveEffects(new ArrayList<>() {{ add(new PassiveEffect("minecraft:wither", 150)); }}));
            ...
            add(new BeeConfig("atm/unobtainium").primaryColor("#bc2feb").secondaryColor("#2e237b").flowerTag("c:storage_blocks/unobtainium").attributes(new HashMap<>(){{  put("endurance", 3); }}).noSelfBreed().invulnerability(new ArrayList<>() {{ add("mekanism.radiation"); }}).requireMod("allthemodium"));
            ...
            add(new BeeConfig("dusts/salty").primaryColor("#fa9f98").secondaryColor("#8a8a8a").particleColor("#fa7d73").flowerFluid("minecraft:water").waterproof().requireTag("c:salts"));
            ...
            add(new BeeConfig("materials/plastic").primaryColor("#d3d3d3").secondaryColor("#535353").size(0.7).flowerTag("c:plastic").attributes(new HashMap<>(){{  put("endurance", 0); }}).requireTag("c:plastic"));
            ...
            add(new BeeConfig("raw_materials/gold").primaryColor("#FCD979").secondaryColor("#804f40").particleColor("#fffd6e").flowerTag("productivebees:flowers/gilded").attributes(new HashMap<>(){{  put("endurance", 0); }}));
            ...
            add(new BeeConfig("raw_materials/netherite").primaryColor("#4d494d").secondaryColor("#804f40").particleColor("#4d494d").flowerTag("c:storage_blocks/netherite").size(0.7).attributes(new HashMap<>(){{  put("endurance", 2); }}).attackResponse("fire").fireproof().withered());
            ...
            add(new BeeConfig("raw_materials/platinum").primaryColor("#6FEAEF").secondaryColor("#804f40").attributes(new HashMap<>(){{  put("endurance", 2); }}).flowerTag("c:storage_blocks/platinum").requireTag("c:storage_blocks/platinum"));
