...
public class BeeProvider implements DataProvider
{
    ...
    protected List<BeeConfig> getBeeConfigs() {
        return new ArrayList<>() {{
            ...
            add(new BeeConfig("obsidian").primaryColor("#3b2754").secondaryColor("#06030b").particleColor("#3b2754").renderer("thicc").size(0.85).attributes(new HashMap<>(){{ put("endurance", GeneValue.ENDURANCE_STRONG.getSerializedName()); }}).flowerTag("c:obsidian"));
            ...
            add(new BeeConfig("modern_industrialization/antimony").primaryColor("#83838f").secondaryColor("#9696a3").tertiaryColor("#b7b7cb").particleColor("#c5c5d7").beeTexture("antimony").flowerBlock("modern_industrialization:antimony_block").requireMod("modern_industrialization"));
            add(new BeeConfig("modern_industrialization/monazite").primaryColor("#471143").secondaryColor("#9f3197").tertiaryColor("#d66dce").particleColor("#f17ce7").beeTexture("monazite").flowerBlock("modern_industrialization:monazite_block").requireMod("modern_industrialization"));
            ...
            add(new BeeConfig("shroom/crimson").primaryColor("#6e1917").secondaryColor("#2f0d06").tertiaryColor("#913000").particleColor("#913000").flowerBlock("minecraft:crimson_fungus").renderer("default_foliage").size(0.5).breedingItem("minecraft:crimson_fungus").attributes(new HashMap<>(){{ put("behavior", GeneValue.BEHAVIOR_NOCTURNAL.getSerializedName()); }}));
            ...
            add(new BeeConfig("shroom/warped").primaryColor("#0c6138").secondaryColor("#0c3326").tertiaryColor("#9a562c").particleColor("#9a3600").flowerBlock("minecraft:warped_fungus").renderer("default_foliage").size(0.5).breedingItem("minecraft:warped_fungus").attributes(new HashMap<>(){{ put("behavior", GeneValue.BEHAVIOR_NOCTURNAL.getSerializedName()); }}));
