...
public class LootModifierProvider extends GlobalLootModifierProvider
{
    ...
    protected void start() {
        add("armadillo_scute_wannabee", new ItemLootModifier(wannabeeConditions(true, "entities/armadillo"), new ItemStack(Items.ARMADILLO_SCUTE), 0.15f));
        add("turtle_scute_wannabee", new ItemLootModifier(wannabeeConditions(true, "entities/turtle"), new ItemStack(Items.TURTLE_SCUTE), 0.15f));
        add("wither_nether_star_wannabee", new ItemLootModifier(wannabeeConditions(true, "entities/wither"), new ItemStack(Items.NETHER_STAR), 0.15f));

        add("sniffer_sussy_egg", new IngredientModifier(wannabeeConditions(false, "gameplay/sniffer_digging"), ComponentIngredient.of(BeeCreator.getSpawnEgg(ResourceLocation.fromNamespaceAndPath(ProductiveBees.MODID, "sussy"))), 0.15f, false));
        add("sussy_amber_egg", new IngredientModifier(wannabeeConditions(false, "archaeology/ocean_ruin_cold"), ComponentIngredient.of(BeeCreator.getSpawnEgg(ResourceLocation.fromNamespaceAndPath(ProductiveBees.MODID, "amber"))), 0.08f, true));
    ...
    private LootItemCondition[] wannabeeConditions(boolean addUUIDCondition, String... rLoc) {
