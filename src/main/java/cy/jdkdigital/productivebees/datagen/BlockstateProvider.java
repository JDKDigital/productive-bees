...
//                        Block hive = BuiltInRegistries.BLOCK.get(new ResourceLocation(ProductiveBees.MODID, "advanced_" + name + "_beehive"));
//                        Block box = BuiltInRegistries.BLOCK.get(new ResourceLocation(ProductiveBees.MODID, "expansion_box_" + name));
...
//        });
//        ModBlocks.hiveStyles.forEach(style ->  {
//            Block hive = BuiltInRegistries.BLOCK.get(new ResourceLocation(ProductiveBees.MODID, "advanced_" + style + "_canvas_beehive"));
//            Block box = BuiltInRegistries.BLOCK.get(new ResourceLocation(ProductiveBees.MODID, "expansion_box_" + style + "_canvas"));
