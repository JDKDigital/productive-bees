    ...
    public static class General
    {
        ...
        public General(ForgeConfigSpec.Builder builder) {
            ...
            preferredTagSource = builder
                    ...
                    .defineList("preferredTagSource", ImmutableList.of("minecraft", ProductiveBees.MODID, "ato", "thermal", "tconstruct", "create", "immersiveengineering", "mekanism", "silents_mechanisms"), obj -> true);
