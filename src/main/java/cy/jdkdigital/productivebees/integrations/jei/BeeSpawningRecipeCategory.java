...
public class BeeSpawningRecipeCategory implements IRecipeCategory<BeeBreedingRecipe> {
    ...
    public BeeSpawningRecipeCategory(IGuiHelper guiHelper) {
        ...
        this.icon = guiHelper.createDrawableIngredient(BeeIngredientHelper.ingredientList.get(ProductiveBees.MODID + ":iron_bee"));
    }
