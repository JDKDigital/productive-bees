...
//            if (chance < 100) {
//                chances.add(Component.translatable("productivebees.centrifuge.tooltip.chance", chance < 1 ? "<1%" : chance + "%"));
//            } else {
//                chances.add(Component.literal(""));
//            }
//            if (value.get(0) != value.get(1)) {
//                amounts.add(Component.translatable("productivebees.centrifuge.tooltip.amount", value.get(0).getAsInt() + " - " + value.get(1).getAsInt()));
//            } else {
//                amounts.add(Component.literal(""));
//            }
//        });
//        Pair<Fluid, Integer> fluid = recipe.getFluidOutputs();
//        if (fluid != null) {
//            chances.add(Component.literal(""));
//            amounts.add(Component.translatable("productivebees.centrifuge.tooltip.amount", fluid.getSecond() + "mB"));
//        }
//
