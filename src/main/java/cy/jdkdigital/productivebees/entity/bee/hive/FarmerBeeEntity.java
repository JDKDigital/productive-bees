                    ...
                    if (distanceToTarget > 1.0D) {
                        ...
                        if (distanceToTarget > 0.1D && ticks > 600) {
                            ...
                            if (!harvestablesNearby.isEmpty()) {
                                ...
                                if (ModList.get().isLoaded("simplefarming") && world instanceof ServerWorld) {
                                    ForgeHooks.onRightClickBlock(FakePlayerFactory.getMinecraft((ServerWorld) world), Hand.MAIN_HAND, pos, FarmerBeeEntity.this.getAdjustedHorizontalFacing());
                                } else {
