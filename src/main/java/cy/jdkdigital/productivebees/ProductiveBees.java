...
import cy.jdkdigital.productivebees.gametest.ProductiveBeesGameTests;
import cy.jdkdigital.productivebees.gametest.TestFunctions;
...
public final class ProductiveBees
{
    ...
    public static final DeferredRegister<MapCodec<? extends LootItemFunction>> LOOT_POOL_FUNCTIONS = DeferredRegister.create(Registries.LOOT_FUNCTION_TYPE, MODID);
    public static final DeferredRegister<MapCodec<? extends LootItemCondition>> LOOT_POOL_CONDITIONS = DeferredRegister.create(Registries.LOOT_CONDITION_TYPE, MODID);
    ...
    public static ResourceKey<CreativeModeTab> TAB_KEY = ResourceKey.create(Registries.CREATIVE_MODE_TAB, Identifier.fromNamespaceAndPath(MODID, MODID));
    ...
    public static final Supplier<AttachmentType<BeeAttributesHandler>> ATTRIBUTE_HANDLER = ATTACHMENT_TYPES.register("attributes_handler", () -> AttachmentType.builder(BeeAttributesHandler::new).serialize(BeeAttributesHandler.CODEC).build());

    public ProductiveBees(IEventBus modEventBus, ModContainer modContainer) {
        @SuppressWarnings("unused")
        Object forceTestsLoad = ProductiveBeesGameTests.MAX_TICKS;
        TestFunctions.init();
