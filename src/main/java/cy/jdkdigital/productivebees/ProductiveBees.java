        ...
        DeferredWorkQueue.runLater(() -> {
            ...
            for (Biome biome : ForgeRegistries.BIOMES) {
                ...
                if (category.equals(Biome.Category.DESERT)) {
                    ...
                    biome.addFeature(GenerationStage.Decoration.TOP_LAYER_MODIFICATION, ModFeatures.NETHER_QUARTZ_NEST.get().withConfiguration(new ReplaceBlockConfig(Blocks.NETHERRACK.getDefaultState(), ModBlocks.NETHER_QUARTZ_NEST.get().getDefaultState())));
