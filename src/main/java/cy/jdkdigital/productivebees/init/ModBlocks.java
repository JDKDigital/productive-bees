...
public final class ModBlocks
{
    ...
    public static final RegistryObject<Block> SNOW_NEST = createBlock("snow_nest", () -> new SnowNest(AbstractBlock.Properties.create(Material.SNOW_BLOCK).hardnessAndResistance(0.2F).sound(SoundType.SNOW)), ModItemGroups.PRODUCTIVE_BEES);
