...
public class ModItems
{
    ...
    public static final RegistryObject<Item> HONEYCOMB_NETHERITE = createItem("honeycomb_netherite", () -> new Honeycomb((new Item.Properties().isBurnable()).group(ModItemGroups.PRODUCTIVE_BEES), "#4d494d"));
