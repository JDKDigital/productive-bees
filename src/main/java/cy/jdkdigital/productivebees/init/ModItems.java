...
public class ModItems
{
    ...
    public static final RegistryObject<Item> HONEY_BUCKET = createItem("honey_bucket", () -> new BucketItem(ModFluids.HONEY, new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(ModItemGroups.PRODUCTIVE_BEES)));
    ...
    public static final RegistryObject<Item> TREAT_ON_A_STICK = createItem("treat_on_a_stick", () -> new TreatOnAStick((new Item.Properties()).maxDamage(28).group(ModItemGroups.PRODUCTIVE_BEES)));
    ...
    public static final RegistryObject<Item> HONEYCOMB_ALFSTEEL = createItem("honeycomb_alfsteel", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("mythicbotany")), "#ffd238"));
    public static final RegistryObject<Item> HONEYCOMB_ALLTHEMODIUM = createItem("honeycomb_allthemodium", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("allthemodium")), "#f2f24f"));
    ...
    public static final RegistryObject<Item> HONEYCOMB_BASALZ = createItem("honeycomb_basalz", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("thermal")), "#ff8219"));
    ...
    public static final RegistryObject<Item> HONEYCOMB_BLITZ = createItem("honeycomb_blitz", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("thermal")), "#e9edf3"));
    public static final RegistryObject<Item> HONEYCOMB_BLIZZ = createItem("honeycomb_blizz", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("thermal")), "#1d7cf1"));
    public static final RegistryObject<Item> HONEYCOMB_BLOODY = createItem("honeycomb_bloody", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("bloodmagic")), "#7a0300"));
    ...
    public static final RegistryObject<Item> HONEYCOMB_CHOCOLATE = createItem("honeycomb_chocolate", () -> new Honeycomb((new Item.Properties()).group(ModItemGroups.PRODUCTIVE_BEES), "#914139"));
    ...
    public static final RegistryObject<Item> HONEYCOMB_COMMON_SALVAGE = createItem("honeycomb_common_salvage", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("mmorpg")), "#495f58"));
    ...
    public static final RegistryObject<Item> HONEYCOMB_ELEMENTIUM = createItem("honeycomb_elementium", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("botania")), "#dc5af8"));
    ...
    public static final RegistryObject<Item> HONEYCOMB_EPIC_SALVAGE = createItem("honeycomb_epic_salvage", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("mmorpg")), "#af1281"));
    ...
    public static final RegistryObject<Item> HONEYCOMB_FLUORITE = createItem("honeycomb_fluorite", () -> new Honeycomb((new Item.Properties()).group(ModItemGroups.PRODUCTIVE_BEES), "#32e1f6"));
    ...
    public static final RegistryObject<Item> HONEYCOMB_GOLD = createItem("honeycomb_gold", () -> new Honeycomb((new Item.Properties()).group(ModItemGroups.PRODUCTIVE_BEES), "#fffd6e"));
    public static final RegistryObject<Item> HONEYCOMB_IMPERIUM = createItem("honeycomb_imperium", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("mysticalagriculture")), "#007FDB"));
    public static final RegistryObject<Item> HONEYCOMB_INFERIUM = createItem("honeycomb_inferium", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("mysticalagriculture")), "#748E00"));
    public static final RegistryObject<Item> HONEYCOMB_INSANIUM = createItem("honeycomb_insanium", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("mysticalagradditions")), "#4d086d"));
    ...
    public static final RegistryObject<Item> HONEYCOMB_LEGENDARY_SALVAGE = createItem("honeycomb_legendary_salvage", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("mmorpg")), "#af8912"));
    ...
    public static final RegistryObject<Item> HONEYCOMB_MANASTEEL = createItem("honeycomb_manasteel", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("botania")), "#4aa7ef"));
    ...
    public static final RegistryObject<Item> HONEYCOMB_NETHERITE = createItem("honeycomb_netherite", () -> new Honeycomb((new Item.Properties().isImmuneToFire()).group(ModItemGroups.PRODUCTIVE_BEES), "#4d494d"));
    ...
    public static final RegistryObject<Item> HONEYCOMB_PROSPERITY = createItem("honeycomb_prosperity", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("mysticalagriculture")), "#ddfbfb"));
    public static final RegistryObject<Item> HONEYCOMB_PRUDENTIUM = createItem("honeycomb_prudentium", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("mysticalagriculture")), "#008C23"));
    ...
    public static final RegistryObject<Item> HONEYCOMB_RARE_SALVAGE = createItem("honeycomb_rare_salvage", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("mmorpg")), "#1286af"));
    ...
    public static final RegistryObject<Item> HONEYCOMB_SOULIUM = createItem("honeycomb_soulium", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("mysticalagriculture")), "#301b10"));
    ...
    public static final RegistryObject<Item> HONEYCOMB_SUPREMIUM = createItem("honeycomb_supremium", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("mysticalagriculture")), "#C40000"));
    public static final RegistryObject<Item> HONEYCOMB_TEA = createItem("honeycomb_tea", () -> new Honeycomb((new Item.Properties()).group(ModItemGroups.PRODUCTIVE_BEES), "#ca7157"));
    public static final RegistryObject<Item> HONEYCOMB_TERRASTEEL = createItem("honeycomb_terrasteel", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("botania")), "#49cc1d"));
    public static final RegistryObject<Item> HONEYCOMB_TERTIUM = createItem("honeycomb_tertium", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("mysticalagriculture")), "#B74900"));
    ...
    public static final RegistryObject<Item> HONEYCOMB_UNCOMMON_SALVAGE = createItem("honeycomb_uncommon_salvage", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("mmorpg")), "#12af4d"));
    public static final RegistryObject<Item> HONEYCOMB_UNOBTAINIUM = createItem("honeycomb_unobtainium", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("allthemodium")), "#bc2feb"));
    public static final RegistryObject<Item> HONEYCOMB_URANINITE = createItem("honeycomb_uraninite", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("powah")), "#00FF00"));
    public static final RegistryObject<Item> HONEYCOMB_VIBRANIUM = createItem("honeycomb_vibranium", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("allthemodium")), "#73ffb9"));
    ...
    public static final RegistryObject<Item> HONEYCOMB_ARDITE = createItem("honeycomb_ardite", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("tconstruct")), "#ffb20b"));
    public static final RegistryObject<Item> HONEYCOMB_COBALT = createItem("honeycomb_cobalt", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("tconstruct")), "#1d77eb"));
    public static final RegistryObject<Item> HONEYCOMB_HEPATIZON = createItem("honeycomb_hepatizon", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("tconstruct")), "#675072"));
    public static final RegistryObject<Item> HONEYCOMB_MANYULLYN = createItem("honeycomb_manyullyn", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("tconstruct")), "#ab6cd7"));
    public static final RegistryObject<Item> HONEYCOMB_KNIGHTSLIME = createItem("honeycomb_knightslime", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("tconstruct")), "#c882f5"));
    public static final RegistryObject<Item> HONEYCOMB_PIG_IRON = createItem("honeycomb_pig_iron", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("tconstruct")), "#dbaaa9"));
    public static final RegistryObject<Item> HONEYCOMB_QUEENS_SLIME = createItem("honeycomb_queens_slime", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("tconstruct")), "#267049"));
    public static final RegistryObject<Item> HONEYCOMB_ROSE_GOLD = createItem("honeycomb_rose_gold", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("tconstruct")), "#eeb9a0"));
    public static final RegistryObject<Item> HONEYCOMB_SLIMESTEEL = createItem("honeycomb_slimesteel", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("tconstruct")), "#7ae7e0"));
    public static final RegistryObject<Item> HONEYCOMB_SOULSTEEL = createItem("honeycomb_soulsteel", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("tconstruct")), "#5c4436"));
    public static final RegistryObject<Item> HONEYCOMB_TINKERS_BRONZE = createItem("honeycomb_tinkers_bronze", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("tconstruct")), "#ffdb7e"));
    public static final RegistryObject<Item> HONEYCOMB_BLUE_SLIMY = createItem("honeycomb_blue_slimy", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("tconstruct")), "#80d4d2"));
    public static final RegistryObject<Item> HONEYCOMB_PURPLE_SLIMY = createItem("honeycomb_purple_slimy", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("tconstruct")), "#d17bfc"));
    public static final RegistryObject<Item> HONEYCOMB_MAGMA_SLIMY = createItem("honeycomb_magma_slimy", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("tconstruct")), "#fcb77b"));
    public static final RegistryObject<Item> HONEYCOMB_SPECTRUM = createItem("honeycomb_spectrum", () -> new Honeycomb((new Item.Properties()).group(ModItemGroups.PRODUCTIVE_BEES), "#ffc9a7"));
    public static final RegistryObject<Item> HONEYCOMB_COSMIC_DUST = createItem("honeycomb_cosmic_dust", () -> new Honeycomb((new Item.Properties()).group(ModItemGroups.PRODUCTIVE_BEES), "#2394cc"));
    public static final RegistryObject<Item> HONEYCOMB_STARMETAL = createItem("honeycomb_starmetal", () -> new Honeycomb((new Item.Properties()).group(itemGroupCompat("astralsorcery")), "#0545b2"));
    ...
    public static final RegistryObject<Item> UPGRADE_FILTER = createItem("upgrade_filter", () -> new FilterUpgradeItem((new Item.Properties().maxStackSize(1)).group(ModItemGroups.PRODUCTIVE_BEES)));
