...
public class ModItems
{
    ...
    public static final RegistryObject<Item> HONEYCOMB_PIGIRON = createItem("honeycomb_pigiron", () -> new Honeycomb((new Item.Properties()).group(ModItemGroups.PRODUCTIVE_BEES), "#dbaaa9"));
