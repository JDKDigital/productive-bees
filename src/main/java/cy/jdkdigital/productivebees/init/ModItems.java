...
public class ModItems
{
    ...
    public static final RegistryObject<Item> HONEYCOMB_ARDITE = createItem("honeycomb_ardite", () -> new Honeycomb((new Item.Properties()).group(null), "#ffb20b"));
    public static final RegistryObject<Item> HONEYCOMB_COBALT = createItem("honeycomb_cobalt", () -> new Honeycomb((new Item.Properties()).group(null), "#1d77eb"));
    public static final RegistryObject<Item> HONEYCOMB_HEPATIZON = createItem("honeycomb_hepatizon", () -> new Honeycomb((new Item.Properties()).group(null), "#675072"));
    public static final RegistryObject<Item> HONEYCOMB_MANYULLYN = createItem("honeycomb_manyullyn", () -> new Honeycomb((new Item.Properties()).group(null), "#ab6cd7"));
    public static final RegistryObject<Item> HONEYCOMB_KNIGHTSLIME = createItem("honeycomb_knightslime", () -> new Honeycomb((new Item.Properties()).group(null), "#c882f5"));
    public static final RegistryObject<Item> HONEYCOMB_PIGIRON = createItem("honeycomb_pigiron", () -> new Honeycomb((new Item.Properties()).group(null), "#dbaaa9"));
    public static final RegistryObject<Item> HONEYCOMB_QUEENS_SLIME = createItem("honeycomb_queens_slime", () -> new Honeycomb((new Item.Properties()).group(null), "#267049"));
    public static final RegistryObject<Item> HONEYCOMB_ROSE_GOLD = createItem("honeycomb_rose_gold", () -> new Honeycomb((new Item.Properties()).group(null), "#eeb9a0"));
    public static final RegistryObject<Item> HONEYCOMB_SLIMESTEEL = createItem("honeycomb_slimesteel", () -> new Honeycomb((new Item.Properties()).group(null), "#7ae7e0"));
    public static final RegistryObject<Item> HONEYCOMB_SOULSTEEL = createItem("honeycomb_soulsteel", () -> new Honeycomb((new Item.Properties()).group(null), "#5c4436"));
    public static final RegistryObject<Item> HONEYCOMB_TINKERS_BRONZE = createItem("honeycomb_tinkers_bronze", () -> new Honeycomb((new Item.Properties()).group(null), "#ffdb7e"));
    public static final RegistryObject<Item> HONEYCOMB_BLUE_SLIMY = createItem("honeycomb_blue_slimy", () -> new Honeycomb((new Item.Properties()).group(null), "#80d4d2"));
    public static final RegistryObject<Item> HONEYCOMB_PURPLE_SLIMY = createItem("honeycomb_purple_slimy", () -> new Honeycomb((new Item.Properties()).group(null), "#d17bfc"));
    public static final RegistryObject<Item> HONEYCOMB_MAGMA_SLIMY = createItem("honeycomb_magma_slimy", () -> new Honeycomb((new Item.Properties()).group(null), "#fcb77b"));
