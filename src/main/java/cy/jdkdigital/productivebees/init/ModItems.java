...
public class ModItems
{
    ...
    public static final RegistryObject<Item> HONEYCOMB_INSANIUM = createItem("honeycomb_insanaium", () -> new Honeycomb((new Item.Properties()).group(ModItemGroups.PRODUCTIVE_BEES), "#4d086d"));
