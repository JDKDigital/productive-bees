...
//    public static PlacedFeature NETHER_QUARTZ_NEST_PLACED;
    ...
    public static RegistryObject<ConfiguredFeature<?, ?>> OAK_SOLITARY_NEST = CONFIGURED_FEATURES.register("oak_solitary_nest", new ConfiguredFeature<>(ModFeatures.SOLITARY_NEST_TREE.get(), TreeFeatures.createOak().decorators(List.of(ModFeatures.WOOD_NEST_DECORATOR)).build()));
    public static RegistryObject<ConfiguredFeature<?, ?>> BIRCH_SOLITARY_NEST = CONFIGURED_FEATURES.register("bich_solitary_nest", new ConfiguredFeature<>(ModFeatures.SOLITARY_NEST_TREE.get(), TreeFeatures.createBirch().decorators(List.of(ModFeatures.WOOD_NEST_DECORATOR)).build()));
    public static RegistryObject<ConfiguredFeature<?, ?>> SPRUCE_SOLITARY_NEST = CONFIGURED_FEATURES.register("spruce_solitary_nest", new ConfiguredFeature<>(ModFeatures.SOLITARY_NEST_TREE.get(), (new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.SPRUCE_LOG), new StraightTrunkPlacer(5, 2, 1), BlockStateProvider.simple(Blocks.SPRUCE_LEAVES), new SpruceFoliagePlacer(UniformInt.of(2, 3), UniformInt.of(0, 2), UniformInt.of(1, 2)), new TwoLayersFeatureSize(2, 0, 2))).ignoreVines().decorators(List.of(ModFeatures.WOOD_NEST_DECORATOR)).build()));
    public static RegistryObject<ConfiguredFeature<?, ?>> ACACIA_SOLITARY_NEST = CONFIGURED_FEATURES.register("acacia_solitary_nest", new ConfiguredFeature<>(ModFeatures.SOLITARY_NEST_TREE.get(), (new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.ACACIA_LOG), new ForkingTrunkPlacer(5, 2, 2), BlockStateProvider.simple(Blocks.ACACIA_LEAVES), new AcaciaFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0)), new TwoLayersFeatureSize(1, 0, 2))).ignoreVines().decorators(List.of(ModFeatures.WOOD_NEST_DECORATOR)).build()));
    public static RegistryObject<ConfiguredFeature<?, ?>> DARK_OAK_SOLITARY_NEST = CONFIGURED_FEATURES.register("dark_oak_solitary_nest", new ConfiguredFeature<>(ModFeatures.SOLITARY_NEST_TREE.get(), (new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.DARK_OAK_LOG), new DarkOakTrunkPlacer(6, 2, 1), BlockStateProvider.simple(Blocks.DARK_OAK_LEAVES), new DarkOakFoliagePlacer(ConstantInt.of(0), ConstantInt.of(0)), new ThreeLayersFeatureSize(1, 1, 0, 1, 2, OptionalInt.empty()))).ignoreVines().decorators(List.of(ModFeatures.WOOD_NEST_DECORATOR)).build()));
    public static RegistryObject<ConfiguredFeature<?, ?>> JUNGLE_SOLITARY_NEST = CONFIGURED_FEATURES.register("jungle_solitary_nest", new ConfiguredFeature<>(ModFeatures.SOLITARY_NEST_TREE.get(), TreeFeatures.createJungleTree().decorators(List.of(ModFeatures.WOOD_NEST_DECORATOR)).build()));

    public static RegistryObject<PlacedFeature> OAK_SOLITARY_NEST_PLACED = PLACED_FEATURES.register("oak_solitary_nest", new PlacedFeature(Holder.direct(OAK_SOLITARY_NEST), List.of(InSquarePlacement.spread(), RarityFilter.onAverageOnceEvery(10), VegetationPlacements.TREE_THRESHOLD, PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING), BiomeFilter.biome())));
    public static RegistryObject<PlacedFeature> BIRCH_SOLITARY_NEST_PLACED = PLACED_FEATURES.register("birch_solitary_nest", new PlacedFeature(Holder.direct(BIRCH_SOLITARY_NEST), List.of(InSquarePlacement.spread(), RarityFilter.onAverageOnceEvery(10), VegetationPlacements.TREE_THRESHOLD, PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING), BiomeFilter.biome())));
