...
{
//    public static final DeferredRegister<ConfiguredFeature<?, ?>> CONFIGURED_FEATURES = DeferredRegister.create(Registries.CONFIGURED_FEATURE, ProductiveBees.MODID);
//    public static final DeferredRegister<PlacedFeature> PLACED_FEATURES = DeferredRegister.create(Registries.PLACED_FEATURE, ProductiveBees.MODID);

    public static final ResourceKey<ConfiguredFeature<?, ?>> SAND_NEST_FEATURE = FeatureUtils.createKey(ProductiveBees.MODID + ":sand_nest");
    public static final ResourceKey<ConfiguredFeature<?, ?>> COARSE_DIRT_NEST_FEATURE = FeatureUtils.createKey(ProductiveBees.MODID + ":coarse_dirt_nest");
    public static final ResourceKey<ConfiguredFeature<?, ?>> SPRUCE_WOOD_NEST_FEATURE = FeatureUtils.createKey(ProductiveBees.MODID + ":spruce_wood_nest");
    public static final ResourceKey<ConfiguredFeature<?, ?>> ACACIA_WOOD_NEST_FEATURE = FeatureUtils.createKey(ProductiveBees.MODID + ":acacia_wood_nest");
    public static final ResourceKey<ConfiguredFeature<?, ?>> JUNGLE_WOOD_NEST_FEATURE = FeatureUtils.createKey(ProductiveBees.MODID + ":jungle_wood_nest");
    public static final ResourceKey<ConfiguredFeature<?, ?>> OAK_WOOD_NEST_FEATURE = FeatureUtils.createKey(ProductiveBees.MODID + ":oak_wood_nest");
    public static final ResourceKey<ConfiguredFeature<?, ?>> DARK_OAK_WOOD_NEST_FEATURE = FeatureUtils.createKey(ProductiveBees.MODID + ":dark_oak_wood_nest");
    public static final ResourceKey<ConfiguredFeature<?, ?>> BIRCH_WOOD_NEST_FEATURE = FeatureUtils.createKey(ProductiveBees.MODID + ":birch_wood_nest");
    public static final ResourceKey<ConfiguredFeature<?, ?>> STONE_NEST_FEATURE = FeatureUtils.createKey(ProductiveBees.MODID + ":stone_nest");
    public static final ResourceKey<ConfiguredFeature<?, ?>> SNOW_NEST_FEATURE = FeatureUtils.createKey(ProductiveBees.MODID + ":snow_nest");
    public static final ResourceKey<ConfiguredFeature<?, ?>> CRIMSON_FUNGUS_BEES_GROW = FeatureUtils.createKey(ProductiveBees.MODID + ":crimson_fungus_bees");
    public static final ResourceKey<ConfiguredFeature<?, ?>> WARPED_FUNGUS_BEES_GROW = FeatureUtils.createKey(ProductiveBees.MODID + ":warped_fungus_bees");
//    public static final ResourceKey<ConfiguredFeature<?, ?>>  = FeatureUtils.createKey(ProductiveBees.MODID + ":");
//    public static final ResourceKey<ConfiguredFeature<?, ?>>  = FeatureUtils.createKey(ProductiveBees.MODID + ":");
